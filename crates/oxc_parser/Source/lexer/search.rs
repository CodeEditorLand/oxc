...
macro_rules! byte_search {
	...
	(
		...
		// called. If `$table` is a `ByteMatchTable`, no such guarantee is given, but
		// call to `$table.use_table()` here makes using this macro unsafe, and it's
		// the user's responsibility to uphold this invariant.
