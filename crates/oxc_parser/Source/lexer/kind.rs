...
/// Lexer token kind
///
/// Exported for other oxc crates to use. You generally don't need to use this
/// directly.
...
impl Kind {
	#[inline]
	pub fn is_eof(self) -> bool { matches!(self, Eof) }
	...
	#[inline]
	pub fn is_identifier(self) -> bool { self.is_identifier_name() && !self.is_reserved_keyword() }

	/// `IdentifierName`
	#[inline]
	pub fn is_identifier_name(self) -> bool { matches!(self, Ident) || self.is_all_keyword() }
	...
	#[inline]
	pub fn is_variable_declaration(self) -> bool { matches!(self, Var | Let | Const) }
	...
	#[inline]
	pub fn is_logical_operator(self) -> bool { matches!(self, Pipe2 | Amp2 | Question2) }
	...
	#[inline]
	pub fn is_update_operator(self) -> bool { matches!(self, Plus2 | Minus2) }
