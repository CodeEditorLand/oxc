...
use super::{VariableDeclarationContext, VariableDeclarationParent, grammar::CoverGrammar};
use crate::{
	Context,
	ParserImpl,
	StatementContext,
...
impl<'a> ParserImpl<'a> {
	...
	pub(crate) fn parse_directives_and_statements(
		...
		while !self.at(Kind::Eof) {
			...
			// check if it is a string literal. All other method are flawed, see test cases in [babel](https://github.com/babel/babel/blob/v7.26.2/packages/babel-parser/test/fixtures/core/categorized/not-directive/input.js)
