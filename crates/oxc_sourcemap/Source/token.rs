...
impl Token {
	...
	pub fn get_dst_line(&self) -> u32 { self.dst_line }

	pub fn get_dst_col(&self) -> u32 { self.dst_col }

	pub fn get_src_line(&self) -> u32 { self.src_line }

	pub fn get_src_col(&self) -> u32 { self.src_col }

	pub fn get_name_id(&self) -> Option<u32> { self.name_id }

	pub fn get_source_id(&self) -> Option<u32> { self.source_id }
}
...
impl<'a> SourceViewToken<'a> {
	pub fn new(token:&'a Token, sourcemap:&'a SourceMap) -> Self { Self { token, sourcemap } }

	pub fn get_dst_line(&self) -> u32 { self.token.dst_line }

	pub fn get_dst_col(&self) -> u32 { self.token.dst_col }

	pub fn get_src_line(&self) -> u32 { self.token.src_line }

	pub fn get_src_col(&self) -> u32 { self.token.src_col }

	pub fn get_name_id(&self) -> Option<u32> { self.token.name_id }

	pub fn get_source_id(&self) -> Option<u32> { self.token.source_id }
