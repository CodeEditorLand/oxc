...
///
/// Note that, due to syntactic restrictions of JSON arrays, this reporter waits
/// until all diagnostics have been reported before writing them to the output
/// stream.
#[derive(Default)]
...
impl DiagnosticReporter for JsonReporter {
	...
	fn finish(&mut self) { format_json(&mut self.diagnostics); }
