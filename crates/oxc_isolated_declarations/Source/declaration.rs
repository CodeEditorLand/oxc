...
impl<'a> IsolatedDeclarations<'a> {
	...
	pub(crate) fn transform_variable_declaration_with_new_declarations(
		...
		self.ast
			.alloc_variable_declaration(decl.span, decl.kind, declarations, self.is_declare())
	}
	...
	fn transform_ts_module_block(
		...
		// We need to enter a new scope for the module block, avoid add binding to the
		// parent scope TODO: doesn't have a scope_id!
