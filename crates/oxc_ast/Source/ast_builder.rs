...
impl<'a> AstBuilder<'a> {
	...
	#[inline]
	pub fn new_vec<T>(self) -> Vec<'a, T> { Vec::new_in(self.allocator) }
	...
	/// Use `move_expression`, `move_statement`, or one of the other `move_*`
	/// methods below instead. <https://github.com/oxc-project/oxc/issues/3483>
	#[inline]
	...
	#[inline]
	pub fn hashbang(self, span:Span, value:Atom<'a>) -> Hashbang<'a> { Hashbang { span, value } }
	...
	#[inline]
	pub fn continue_statement(self, span:Span, label:Option<LabelIdentifier<'a>>) -> Statement<'a> {
	...
	#[inline]
	pub fn parenthesized_expression(self, span:Span, expression:Expression<'a>) -> Expression<'a> {
	...
	#[inline]
	pub fn spread_element(self, span:Span, argument:Expression<'a>) -> Box<'a, SpreadElement<'a>> {
	...
	#[inline]
	pub fn ts_tuple_type(self, span:Span, element_types:Vec<'a, TSTupleElement<'a>>) -> TSType<'a> {
	...
	#[inline]
	pub fn ts_enum_member_name_string_literal(self, lit:StringLiteral<'a>) -> TSEnumMemberName<'a> {
