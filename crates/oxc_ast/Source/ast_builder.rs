...
impl<'a> AstBuilder<'a> {
	...
	pub fn void_0(self) -> Expression<'a> {
		let left =
			self.number_literal(Span::default(), 0.0, "0", NumberBase::Decimal);
	...
	#[inline]
	pub fn literal_string_expression(
		self,
	...
	#[inline]
	pub fn literal_boolean_expression(
		self,
	...
	#[inline]
	pub fn literal_null_expression(
		self,
		literal: NullLiteral,
	) -> Expression<'a> {
	...
	#[inline]
	pub fn literal_regexp_expression(
		self,
		literal: RegExpLiteral<'a>,
	) -> Expression<'a> {
		Expression::RegExpLiteral(self.alloc(literal))
	}

	#[inline]
	pub fn literal_number_expression(
		self,
	...
	#[inline]
	pub fn literal_bigint_expression(
		self,
		literal: BigIntLiteral<'a>,
	) -> Expression<'a> {
		Expression::BigIntLiteral(self.alloc(literal))
	}

	#[inline]
	pub fn literal_template_expression(
		self,
		literal: TemplateLiteral<'a>,
	) -> Expression<'a> {
	...
	pub fn using_statement(
		...
		Statement::UsingDeclaration(self.alloc(UsingDeclaration {
			span,
			is_await,
			declarations,
		}))
	...
	pub fn for_in_statement(
		...
		Statement::ForInStatement(
			self.alloc(ForInStatement::new(span, left, right, body)),
		)
	}
	...
	pub fn for_of_statement(
		...
		Statement::ForOfStatement(
			self.alloc(ForOfStatement::new(span, r#await, left, right, body)),
		)
	}
	...
	pub fn for_statement(
		...
		Statement::ForStatement(
			self.alloc(ForStatement::new(span, init, test, update, body)),
		)
	}
	...
	pub fn switch_statement(
		...
		Statement::SwitchStatement(self.alloc(SwitchStatement::new(
			span,
			discriminant,
			cases,
		)))
	...
	pub fn computed_member(
		...
		MemberExpression::ComputedMemberExpression(self.alloc(
	...
	pub fn computed_member_expression(
		...
		self.member_expression(
			self.computed_member(span, object, expression, optional),
		)
	}
	...
	pub fn static_member_expression(
		...
		self.member_expression(
			self.static_member(span, object, property, optional),
		)
	}
	...
	pub fn private_field_expression(
		...
		self.member_expression(
			self.private_field(span, object, field, optional),
		)
	}
	...
	pub fn tagged_template_expression(
		...
		Expression::TaggedTemplateExpression(self.alloc(
	...
	pub fn plain_function(
		...
		self.function(
			r#type, span, id, false, false, false, None, params, body, None,
			None,
		)
	}
	...
	pub fn class_constructor(
		...
		ClassElement::MethodDefinition(self.alloc(MethodDefinition {
			...
			span,
			key: self.property_key_expression(
				self.identifier_reference_expression(IdentifierReference::new(
					SPAN,
					"constructor".into(),
				)),
			),
	...
	#[inline]
	pub fn property_key_identifier(
		self,
	...
	#[inline]
	pub fn property_key_private_identifier(
		self,
	...
	#[inline]
	pub fn property_key_expression(
		self,
		expr: Expression<'a>,
	) -> PropertyKey<'a> {
	...
	pub fn ts_parenthesized_type(
		...
		TSType::TSParenthesizedType(
			self.alloc(TSParenthesizedType { span, type_annotation: ty }),
		)
	}
	...
	pub fn ts_type_operator_type(
		...
		TSType::TSTypeOperatorType(self.alloc(TSTypeOperator {
			span,
			operator,
			type_annotation,
		}))
	...
	pub fn ts_type_parameter(
		...
		TSTypeParameter::new(
			span, name, constraint, default, r#in, out, r#const,
		)
	}
	...
	pub fn ts_call_signature_declaration(
		...
		TSSignature::TSCallSignatureDeclaration(self.alloc(
	...
	pub fn ts_instantiation_expression(
		...
		Expression::TSInstantiationExpression(self.alloc(
	...
	pub fn ts_import_equals_declaration(
		...
		Declaration::TSImportEqualsDeclaration(self.alloc(
	...
	pub fn ts_interface_declaration(
		...
		Declaration::TSInterfaceDeclaration(self.alloc(
	...
	pub fn ts_type_alias_declaration(
		...
		Declaration::TSTypeAliasDeclaration(self.alloc(
	...
	pub fn ts_enum_declaration(
		...
		Declaration::TSEnumDeclaration(
			self.alloc(TSEnumDeclaration::new(
				span, id, members, r#const, declare,
			)),
		)
	}
	...
	pub fn ts_template_literal_type(
		...
		TSType::TSTemplateLiteralType(self.alloc(TSTemplateLiteralType {
			span,
			quasis,
			types,
		}))
	...
	#[inline]
	pub fn ts_type_predicate_name_this(
		self,
		ty: TSThisType,
	...
	pub fn js_doc_nullable_type(
		...
		TSType::JSDocNullableType(self.alloc(JSDocNullableType {
			span,
			type_annotation,
			postfix,
		}))
