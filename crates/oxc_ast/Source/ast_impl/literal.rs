...
impl BooleanLiteral {
	pub fn new(span:Span, value:bool) -> Self { Self { span, value } }
...
impl<'a> NumericLiteral<'a> {
	...
	pub fn ecmascript_to_int32(num:f64) -> i32 {
		...
		// NaN, Infinity if not included in our NumericLiteral, so we just
		// serde(skip) step 2.
...
impl<'a> StringLiteral<'a> {
	pub fn new(span:Span, value:Atom<'a>) -> Self { Self { span, value } }
