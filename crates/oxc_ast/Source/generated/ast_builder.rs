...
impl<'a> AstBuilder<'a> {
	...
	///
	/// This node contains a [`IdentifierReference`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ArrayExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ArrowFunctionExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ArrowFunctionExpression`] into a
	...
	///
	/// This node contains a [`AssignmentExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`AssignmentExpression`] into a
	/// [`Expression::AssignmentExpression`]
	#[inline]
	...
	///
	/// This node contains a [`AwaitExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ConditionalExpression`] into a
	/// [`Expression::ConditionalExpression`]
	#[inline]
	...
	///
	/// This node contains a [`ImportExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ObjectExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ParenthesizedExpression`] into a
	/// [`Expression::ParenthesizedExpression`]
	#[inline]
	...
	/// Convert a [`SequenceExpression`] into a
	...
	/// Convert a [`TaggedTemplateExpression`] into a
	...
	///
	/// This node contains a [`UnaryExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`UpdateExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`PrivateInExpression`] into a
	/// [`Expression::PrivateInExpression`]
	#[inline]
	...
	/// Convert a [`TSSatisfiesExpression`] into a
	...
	/// Convert a [`TSNonNullExpression`] into a
	...
	/// Convert a [`TSInstantiationExpression`] into a
	...
	/// Convert a [`SpreadElement`] into a
	...
	///
	/// This node contains a [`ObjectProperty`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ObjectProperty`] into a
	/// [`ObjectPropertyKind::ObjectProperty`]
	#[inline]
	...
	///
	/// This node contains a [`IdentifierName`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`PrivateIdentifier`] into a
	...
	/// Convert a [`ComputedMemberExpression`] into a
	/// [`MemberExpression::ComputedMemberExpression`]
	#[inline]
	...
	/// Convert a [`StaticMemberExpression`] into a
	/// [`MemberExpression::StaticMemberExpression`]
	#[inline]
	...
	/// Convert a [`PrivateFieldExpression`] into a
	/// [`MemberExpression::PrivateFieldExpression`]
	#[inline]
	...
	#[inline]
	pub fn argument_expression(self, inner:Expression<'a>) -> Argument<'a> { Argument::from(inner) }
	...
	/// Convert a [`IdentifierReference`] into a
	/// [`SimpleAssignmentTarget::AssignmentTargetIdentifier`]
	#[inline]
	...
	/// Convert a [`TSAsExpression`] into a
	/// [`SimpleAssignmentTarget::TSAsExpression`]
	#[inline]
	...
	/// Convert a [`TSSatisfiesExpression`] into a
	/// [`SimpleAssignmentTarget::TSSatisfiesExpression`]
	#[inline]
	...
	/// Convert a [`TSTypeAssertion`] into a
	/// [`SimpleAssignmentTarget::TSTypeAssertion`]
	#[inline]
	...
	///
	/// This node contains a [`ArrayAssignmentTarget`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ArrayAssignmentTarget`] into a
	...
	///
	/// This node contains a [`ObjectAssignmentTarget`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ObjectAssignmentTarget`] into a
	/// [`AssignmentTargetPattern::ObjectAssignmentTarget`]
	#[inline]
	...
	///
	/// This node contains a [`AssignmentTargetWithDefault`] that will be stored
	/// in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`AssignmentTargetWithDefault`] into a
	/// [`AssignmentTargetMaybeDefault::AssignmentTargetWithDefault`]
	#[inline]
	...
	/// Builds a [`AssignmentTargetWithDefault`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	...
	///
	/// This node contains a [`AssignmentTargetPropertyIdentifier`] that will be
	...
	/// Convert a [`AssignmentTargetPropertyIdentifier`] into a
	/// [`AssignmentTargetProperty::AssignmentTargetPropertyIdentifier`]
	#[inline]
	...
	///
	/// This node contains a [`AssignmentTargetPropertyProperty`] that will be
	/// stored in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`AssignmentTargetPropertyProperty`] into a
	/// [`AssignmentTargetProperty::AssignmentTargetPropertyProperty`]
	#[inline]
	...
	/// Builds a [`AssignmentTargetPropertyIdentifier`] and stores it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	...
	/// Builds a [`AssignmentTargetPropertyProperty`] and stores it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	...
	///
	/// This node contains a [`EmptyStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ExpressionStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ExpressionStatement`] into a
	...
	///
	/// This node contains a [`IfStatement`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`VariableDeclaration`] into a
	...
	/// Convert a [`TSTypeAliasDeclaration`] into a
	...
	/// Convert a [`TSInterfaceDeclaration`] into a
	...
	/// Convert a [`TSEnumDeclaration`] into a
	/// [`Declaration::TSEnumDeclaration`]
	#[inline]
	...
	/// Convert a [`TSModuleDeclaration`] into a
	/// [`Declaration::TSModuleDeclaration`]
	#[inline]
	...
	/// Convert a [`TSImportEqualsDeclaration`] into a
	...
	/// Convert a [`VariableDeclaration`] into a
	/// [`ForStatementInit::VariableDeclaration`]
	#[inline]
	...
	/// Convert a [`BindingIdentifier`] into a
	/// [`BindingPatternKind::BindingIdentifier`]
	#[inline]
	pub fn binding_pattern_kind_from_binding_identifier<T>(
		self,
		inner:T,
	) -> BindingPatternKind<'a>
	where
	...
	///
	/// This node contains a [`ObjectPattern`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ArrayPattern`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`AssignmentPattern`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`AssignmentPattern`] into a
	/// [`BindingPatternKind::AssignmentPattern`]
	#[inline]
	pub fn binding_pattern_kind_from_assignment_pattern<T>(
		self,
		inner:T,
	) -> BindingPatternKind<'a>
	where
	...
	/// Convert a [`PropertyDefinition`] into a
	...
	///
	/// This node contains a [`AccessorProperty`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - r#type
	...
	///
	/// This node contains a [`ImportDeclaration`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ImportDeclaration`] into a
	...
	///
	/// This node contains a [`ExportAllDeclaration`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ExportAllDeclaration`] into a
	...
	///
	/// This node contains a [`ExportDefaultDeclaration`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ExportDefaultDeclaration`] into a
	...
	///
	/// This node contains a [`ExportNamedDeclaration`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ExportNamedDeclaration`] into a
	...
	/// Convert a [`TSExportAssignment`] into a
	/// [`ModuleDeclaration::TSExportAssignment`]
	#[inline]
	...
	/// Convert a [`TSNamespaceExportDeclaration`] into a
	/// [`ModuleDeclaration::TSNamespaceExportDeclaration`]
	#[inline]
	...
	///
	/// This node contains a [`ImportSpecifier`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ImportSpecifier`] into a
	...
	///
	/// This node contains a [`ImportDefaultSpecifier`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ImportDefaultSpecifier`] into a
	/// [`ImportDeclarationSpecifier::ImportDefaultSpecifier`]
	#[inline]
	...
	///
	/// This node contains a [`ImportNamespaceSpecifier`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Convert a [`ImportNamespaceSpecifier`] into a
	/// [`ImportDeclarationSpecifier::ImportNamespaceSpecifier`]
	#[inline]
	...
	/// Convert a [`IdentifierName`] into a
	...
	/// Convert a [`StringLiteral`] into a
	/// [`TSEnumMemberName::StaticStringLiteral`]
	#[inline]
	...
	/// Convert a [`TemplateLiteral`] into a
	/// [`TSEnumMemberName::StaticTemplateLiteral`]
	#[inline]
	...
	/// Convert a [`NumericLiteral`] into a
	/// [`TSEnumMemberName::StaticNumericLiteral`]
	#[inline]
	...
	/// Convert a [`TSTemplateLiteralType`] into a
	/// [`TSType::TSTemplateLiteralType`]
	#[inline]
	...
	/// Convert a [`JSDocNonNullableType`] into a
	...
	/// Builds a [`TSTypeParameterInstantiation`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	...
	/// Builds a [`TSTypeParameterDeclaration`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	...
	/// Convert a [`TSPropertySignature`] into a
	...
	/// Convert a [`TSCallSignatureDeclaration`] into a
	...
	/// Convert a [`TSConstructSignatureDeclaration`] into a
	...
	/// Convert a [`TSMethodSignature`] into a
	...
	/// Builds a [`TSCallSignatureDeclaration`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	...
	/// Builds a [`TSConstructSignatureDeclaration`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	...
	#[inline]
	pub fn ts_type_predicate_name_from_identifier_name<T>(
		self,
		inner:T,
	) -> TSTypePredicateName<'a>
	where
	...
	/// Convert a [`TSModuleBlock`] into a
	/// [`TSModuleDeclarationBody::TSModuleBlock`]
	#[inline]
	...
	#[inline]
	pub fn ts_type_query_expr_name_from_ts_import_type<T>(
		self,
		inner:T,
	) -> TSTypeQueryExprName<'a>
	where
	...
	/// Convert a [`IdentifierName`] into a
	/// [`TSImportAttributeName::Identifier`]
	#[inline]
	...
	/// Convert a [`StringLiteral`] into a
	/// [`TSImportAttributeName::StringLiteral`]
	#[inline]
	...
	/// Builds a [`TSImportEqualsDeclaration`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	...
	/// Convert a [`TSExternalModuleReference`] into a
	/// [`TSModuleReference::ExternalModuleReference`]
	#[inline]
	...
	/// Builds a [`TSExternalModuleReference`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	...
	/// Builds a [`TSNamespaceExportDeclaration`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	...
	/// Builds a [`TSInstantiationExpression`] and stores it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	...
	/// Convert a [`JSXNamespacedName`] into a
	/// [`JSXElementName::NamespacedName`]
	#[inline]
	...
	/// Convert a [`JSXMemberExpression`] into a
	/// [`JSXElementName::MemberExpression`]
	#[inline]
	...
	/// Convert a [`ThisExpression`] into a
	...
	/// Convert a [`JSXEmptyExpression`] into a
	...
	/// Convert a [`JSXSpreadAttribute`] into a
	...
	/// Convert a [`JSXExpressionContainer`] into a
	/// [`JSXAttributeValue::ExpressionContainer`]
	#[inline]
