...
impl<'a> AstBuilder<'a> {
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_boolean_literal`] instead.
	///
	/// ## Parameters
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::boolean_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - value: The boolean value itself
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_null_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	#[inline]
	pub fn null_literal(self, span:Span) -> NullLiteral { NullLiteral { span } }

	/// Build a [`NullLiteral`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::null_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_numeric_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::numeric_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - value: The value of the number, converted into base 10
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_string_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::string_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - value: The value of the string.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_big_int_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::big_int_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - raw: The bigint as it appears in source code
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_reg_exp_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - regex: The parsed regular expression. See [`oxc_regular_expression`]
	///   for more
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::reg_exp_literal`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - regex: The parsed regular expression. See [`oxc_regular_expression`]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_program`] instead.
	///
	/// ## Parameters
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::program`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - source_type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_program_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - source_type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::program_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - source_type
	...
	///
	/// This node contains a [`BooleanLiteral`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`NullLiteral`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`NumericLiteral`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`BigIntLiteral`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`RegExpLiteral`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`StringLiteral`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`TemplateLiteral`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`IdentifierReference`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`MetaProperty`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ArrayExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ArrowFunctionExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression: Is the function body an arrow expression? i.e. `() =>
	///   expr` instead of `() => {}`
	/// - r#async
	/// - type_parameters
	/// - params
	/// - return_type
	/// - body: See `expression` for whether this arrow expression returns an
	///   expression.
	#[inline]
	...
	///
	/// This node contains an [`AssignmentExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`AwaitExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`BinaryExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`CallExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ChainExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ConditionalExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`Function`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	/// - id: The function identifier. [`None`] for anonymous function
	///   expressions.
	...
	///
	/// This node contains an [`ImportExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`LogicalExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`NewExpression`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ObjectExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ParenthesizedExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`SequenceExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TaggedTemplateExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ThisExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`UnaryExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`UpdateExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`YieldExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`PrivateInExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`JSXElement`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - opening_element: Opening tag of the element.
	/// - closing_element: Closing tag of the element. Will be [`None`] for
	///   self-closing tags.
	/// - children: Children of the element. This can be text, other elements,
	///   or expressions.
	#[inline]
	...
	///
	/// This node contains a [`JSXFragment`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`TSAsExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSSatisfiesExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTypeAssertion`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSNonNullExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSInstantiationExpression`] that will be stored
	/// in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_identifier_name`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::identifier_name`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_identifier_reference`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The name of the identifier being referenced.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::identifier_reference`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The name of the identifier being referenced.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_identifier_reference_with_reference_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The name of the identifier being referenced.
	...
	/// Build an [`IdentifierReference`] with `ReferenceId`, and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::identifier_reference_with_reference_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The name of the identifier being referenced.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_binding_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	where
		A: IntoIn<'a, Atom<'a>>, {
		BindingIdentifier { span, name:name.into_in(self.allocator), symbol_id:Default::default() }
	}

	/// Build a [`BindingIdentifier`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::binding_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The identifier name being bound.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_binding_identifier_with_symbol_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The identifier name being bound.
	...
	/// Build a [`BindingIdentifier`] with `SymbolId`, and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::binding_identifier_with_symbol_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The identifier name being bound.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_label_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::label_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_this_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn this_expression(self, span:Span) -> ThisExpression { ThisExpression { span } }

	/// Build a [`ThisExpression`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::this_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_array_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - elements
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::array_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - elements
	...
	///
	/// This node contains a [`SpreadElement`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_elision`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn elision(self, span:Span) -> Elision { Elision { span } }

	/// Build an [`Elision`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::elision`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_object_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - properties: Properties declared in the object
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::object_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - properties: Properties declared in the object
	...
	///
	/// This node contains an [`ObjectProperty`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_object_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::object_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// This node contains an [`IdentifierName`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`PrivateIdentifier`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_template_literal`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - quasis
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::template_literal`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - quasis
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_tagged_template_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - tag
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::tagged_template_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_template_element`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - tail
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::template_element`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - tail
	...
	///
	/// This node contains a [`ComputedMemberExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`StaticMemberExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`PrivateFieldExpression`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_computed_member_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - object
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::computed_member_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_static_member_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - object
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::static_member_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_private_field_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - object
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::private_field_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_call_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - callee
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::call_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - callee
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_new_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - callee
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::new_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - callee
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_meta_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - meta
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::meta_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - meta
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_spread_element`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument: The expression being spread.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::spread_element`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument: The expression being spread.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_update_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::update_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_unary_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::unary_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_binary_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::binary_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_private_in_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::private_in_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_logical_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::logical_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_conditional_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - test
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::conditional_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_assignment_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::assignment_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// This node contains an [`ArrayAssignmentTarget`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ObjectAssignmentTarget`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_array_assignment_target`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - elements
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::array_assignment_target`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_object_assignment_target`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - properties
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::object_assignment_target`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_assignment_target_rest`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - target
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::assignment_target_rest`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`AssignmentTargetWithDefault`] that will be
	/// stored in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - binding
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_assignment_target_with_default`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - binding
	...
	/// Build an [`AssignmentTargetWithDefault`], and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::assignment_target_with_default`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`AssignmentTargetPropertyIdentifier`] that will
	/// be stored in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - binding
	...
	///
	/// This node contains an [`AssignmentTargetPropertyProperty`] that will be
	/// stored in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_assignment_target_property_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - binding
	...
	/// Build an [`AssignmentTargetPropertyIdentifier`], and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::assignment_target_property_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - binding
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_assignment_target_property_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	/// Build an [`AssignmentTargetPropertyProperty`], and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::assignment_target_property_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_sequence_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expressions
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::sequence_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expressions
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_super_`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn super_(self, span:Span) -> Super { Super { span } }

	/// Build a [`Super`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::super_`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_await_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::await_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_chain_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::chain_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_parenthesized_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::parenthesized_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`BlockStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`BreakStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ContinueStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`DebuggerStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`DoWhileStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`EmptyStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ExpressionStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ForInStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ForOfStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ForStatement`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`IfStatement`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`LabeledStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ReturnStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`SwitchStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`ThrowStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TryStatement`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - block: Statements in the `try` block
	/// - handler: The `catch` clause, including the parameter and the block
	///   statement
	...
	///
	/// This node contains a [`WhileStatement`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`WithStatement`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_directive`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression: Directive with any escapes unescaped
	/// - directive: Raw content of directive as it appears in source, any
	///   escapes left as is
	#[inline]
	pub fn directive<A>(
		self,
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::directive`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression: Directive with any escapes unescaped
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_hashbang`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - value
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::hashbang`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - value
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_block_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::block_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_block_statement_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	/// Build a [`BlockStatement`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::block_statement_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`VariableDeclaration`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTypeAliasDeclaration`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSInterfaceDeclaration`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSEnumDeclaration`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSModuleDeclaration`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSImportEqualsDeclaration`] that will be stored
	/// in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_variable_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::variable_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_variable_declarator`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::variable_declarator`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_empty_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn empty_statement(self, span:Span) -> EmptyStatement { EmptyStatement { span } }

	/// Build an [`EmptyStatement`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::empty_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_expression_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::expression_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_if_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - test
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::if_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - test
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_do_while_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::do_while_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_while_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - test
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::while_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - test
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_for_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - init
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::for_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - init
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_for_statement_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - init
	...
	/// Build a [`ForStatement`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::for_statement_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_for_in_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::for_in_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_for_in_statement_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	/// Build a [`ForInStatement`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::for_in_statement_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_for_of_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#await
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::for_of_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#await
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_for_of_statement_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#await
	...
	/// Build a [`ForOfStatement`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::for_of_statement_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_continue_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - label
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::continue_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - label
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_break_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - label
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::break_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - label
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_return_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::return_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_with_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - object
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::with_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - object
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_switch_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - discriminant
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::switch_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - discriminant
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_switch_statement_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - discriminant
	...
	/// Build a [`SwitchStatement`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::switch_statement_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_switch_case`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - test
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::switch_case`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - test
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_labeled_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - label
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::labeled_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - label
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_throw_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument: The expression being thrown, e.g. `err` in `throw err;`
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::throw_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument: The expression being thrown, e.g. `err` in `throw err;`
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_try_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - block: Statements in the `try` block
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::try_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - block: Statements in the `try` block
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_catch_clause`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	where
		T1: IntoIn<'a, Box<'a, BlockStatement<'a>>>, {
		CatchClause { span, param, body:body.into_in(self.allocator), scope_id:Default::default() }
	}

	/// Build a [`CatchClause`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::catch_clause`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - param: The caught error parameter, e.g. `e` in `catch (e) {}`
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_catch_clause_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - param: The caught error parameter, e.g. `e` in `catch (e) {}`
	...
	/// Build a [`CatchClause`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::catch_clause_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_catch_parameter`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::catch_parameter`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - pattern: The bound error
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_debugger_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn debugger_statement(self, span:Span) -> DebuggerStatement { DebuggerStatement { span } }

	/// Build a [`DebuggerStatement`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::debugger_statement`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_binding_pattern`] instead.
	///
	/// ## Parameters
	/// - kind
	/// - type_annotation
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::binding_pattern`] instead.
	///
	/// ## Parameters
	/// - kind
	/// - type_annotation
	...
	///
	/// This node contains a [`BindingIdentifier`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ObjectPattern`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ArrayPattern`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`AssignmentPattern`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_assignment_pattern`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::assignment_pattern`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_object_pattern`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - properties
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::object_pattern`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - properties
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_binding_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::binding_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_array_pattern`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - elements
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::array_pattern`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - elements
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_binding_rest_element`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::binding_rest_element`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - argument
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_function`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::function`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_function_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::function_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_formal_parameters`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::formal_parameters`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - kind
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_formal_parameter`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - decorators
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::formal_parameter`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - decorators
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_function_body`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - directives
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::function_body`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - directives
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_arrow_function_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression: Is the function body an arrow expression? i.e. `() =>
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::arrow_function_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_arrow_function_expression_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression: Is the function body an arrow expression? i.e. `() =>
	...
	/// Build an [`ArrowFunctionExpression`] with `ScopeId`, and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::arrow_function_expression_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression: Is the function body an arrow expression? i.e. `() =>
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_yield_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - delegate
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::yield_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - delegate
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_class`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::class`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_class_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	/// - r#abstract: Whether the class is abstract
	/// - declare: Whether the class was `declare`ed
	/// - scope_id: Id of the scope created by the [`Class`], including type
	///   parameters and
	#[inline]
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::class_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_class_body`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::class_body`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// This node contains a [`StaticBlock`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`MethodDefinition`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`PropertyDefinition`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`AccessorProperty`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSIndexSignature`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_method_definition`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type: Method definition type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::method_definition`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type: Method definition type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_property_definition`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::property_definition`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_private_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::private_identifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_static_block`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::static_block`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_static_block_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	/// Build a [`StaticBlock`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::static_block_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ImportDeclaration`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - specifiers: `None` for `import 'foo'`, `Some([])` for `import {} from
	///   'foo'`
	/// - source
	/// - phase
	...
	///
	/// This node contains an [`ExportAllDeclaration`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ExportDefaultDeclaration`] that will be stored
	/// in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ExportNamedDeclaration`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSExportAssignment`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSNamespaceExportDeclaration`] that will be
	/// stored in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_accessor_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::accessor_property`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_import_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - source
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::import_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - source
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_import_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - specifiers: `None` for `import 'foo'`, `Some([])` for `import {} from
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::import_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - specifiers: `None` for `import 'foo'`, `Some([])` for `import {} from
	...
	///
	/// This node contains an [`ImportSpecifier`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ImportDefaultSpecifier`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains an [`ImportNamespaceSpecifier`] that will be stored
	/// in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_import_specifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - imported
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::import_specifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - imported
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_import_default_specifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - local: The name of the imported symbol.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::import_default_specifier`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_import_namespace_specifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - local
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::import_namespace_specifier`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_with_clause`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - attributes_keyword
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::with_clause`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - attributes_keyword
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_import_attribute`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::import_attribute`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_export_named_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - declaration
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::export_named_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_export_default_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - declaration
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::export_default_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_export_all_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - exported: If this declaration is re-named
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::export_all_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_export_specifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - local
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::export_specifier`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - local
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_this_parameter`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - this_span
	/// - type_annotation: Type type the `this` keyword will have in the
	///   function
	#[inline]
	...
	where
		T1: IntoIn<'a, Option<Box<'a, TSTypeAnnotation<'a>>>>, {
		TSThisParameter { span, this_span, type_annotation:type_annotation.into_in(self.allocator) }
	}

	/// Build a [`TSThisParameter`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_this_parameter`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - this_span
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_enum_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_enum_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_enum_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	/// Build a [`TSEnumDeclaration`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_enum_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_enum_member`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_enum_member`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_annotation`] instead.
	///
	/// ## Parameters
	/// - span: starts at the `:` token and ends at the end of the type
	///   annotation
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_annotation`] instead.
	///
	/// ## Parameters
	/// - span: starts at the `:` token and ends at the end of the type
	///   annotation
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_literal_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - literal
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_literal_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - literal
	...
	///
	/// This node contains a [`TSAnyKeyword`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSBigIntKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSBooleanKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSIntrinsicKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSNeverKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSNullKeyword`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSNumberKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSObjectKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSStringKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSSymbolKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSUndefinedKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSUnknownKeyword`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSVoidKeyword`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSArrayType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSConditionalType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSConstructorType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSFunctionType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSImportType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSIndexedAccessType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSInferType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSIntersectionType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSLiteralType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSMappedType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSNamedTupleMember`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSQualifiedName`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTemplateLiteralType`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSThisType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTupleType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTypeLiteral`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTypeOperator`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTypePredicate`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTypeQuery`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSTypeReference`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSUnionType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSParenthesizedType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`JSDocNullableType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`JSDocNonNullableType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`JSDocUnknownType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_conditional_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - check_type: The type before `extends` in the test expression.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_conditional_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - check_type: The type before `extends` in the test expression.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_conditional_type_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - check_type: The type before `extends` in the test expression.
	...
	/// Build a [`TSConditionalType`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_conditional_type_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - check_type: The type before `extends` in the test expression.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_union_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - types: The types in the union.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_union_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - types: The types in the union.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_intersection_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - types
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_intersection_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - types
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_parenthesized_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_parenthesized_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_operator`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_operator`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - operator
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_array_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - element_type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_array_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - element_type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_indexed_access_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - object_type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_indexed_access_type`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_tuple_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - element_types
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_tuple_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - element_types
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_named_tuple_member`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - element_type
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_named_tuple_member`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - element_type
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_optional_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_optional_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_rest_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_rest_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// This node contains a [`TSOptionalType`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSRestType`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_any_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_any_keyword(self, span:Span) -> TSAnyKeyword { TSAnyKeyword { span } }

	/// Build a [`TSAnyKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_any_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_string_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_string_keyword(self, span:Span) -> TSStringKeyword { TSStringKeyword { span } }

	/// Build a [`TSStringKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_string_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_boolean_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_boolean_keyword(self, span:Span) -> TSBooleanKeyword { TSBooleanKeyword { span } }

	/// Build a [`TSBooleanKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_boolean_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_number_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_number_keyword(self, span:Span) -> TSNumberKeyword { TSNumberKeyword { span } }

	/// Build a [`TSNumberKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_number_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_never_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_never_keyword(self, span:Span) -> TSNeverKeyword { TSNeverKeyword { span } }

	/// Build a [`TSNeverKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_never_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_intrinsic_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_intrinsic_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_unknown_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_unknown_keyword(self, span:Span) -> TSUnknownKeyword { TSUnknownKeyword { span } }

	/// Build a [`TSUnknownKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_unknown_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_null_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_null_keyword(self, span:Span) -> TSNullKeyword { TSNullKeyword { span } }

	/// Build a [`TSNullKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_null_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_undefined_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_undefined_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_void_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_void_keyword(self, span:Span) -> TSVoidKeyword { TSVoidKeyword { span } }

	/// Build a [`TSVoidKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_void_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_symbol_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_symbol_keyword(self, span:Span) -> TSSymbolKeyword { TSSymbolKeyword { span } }

	/// Build a [`TSSymbolKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_symbol_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_this_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_this_type(self, span:Span) -> TSThisType { TSThisType { span } }

	/// Build a [`TSThisType`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_this_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_object_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_object_keyword(self, span:Span) -> TSObjectKeyword { TSObjectKeyword { span } }

	/// Build a [`TSObjectKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_object_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_big_int_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn ts_big_int_keyword(self, span:Span) -> TSBigIntKeyword { TSBigIntKeyword { span } }

	/// Build a [`TSBigIntKeyword`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_big_int_keyword`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_reference`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_name
	...
	where
		T1: IntoIn<'a, Option<Box<'a, TSTypeParameterInstantiation<'a>>>>, {
		TSTypeReference { span, type_name, type_parameters:type_parameters.into_in(self.allocator) }
	}

	/// Build a [`TSTypeReference`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_reference`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_name
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_qualified_name`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_qualified_name`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - left
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_parameter_instantiation`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - params
	...
	/// Build a [`TSTypeParameterInstantiation`], and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_type_parameter_instantiation`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - params
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_parameter`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name: The name of the parameter, e.g. `T` in `type Foo<T> = ...`.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_parameter_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - params
	...
	/// Build a [`TSTypeParameterDeclaration`], and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_parameter_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_alias_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: Type alias's identifier, e.g. `Foo` in `type Foo = number`.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_alias_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_alias_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: Type alias's identifier, e.g. `Foo` in `type Foo = number`.
	...
	/// Build a [`TSTypeAliasDeclaration`] with `ScopeId`, and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_type_alias_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: Type alias's identifier, e.g. `Foo` in `type Foo = number`.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_class_implements`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_class_implements`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_interface_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: The identifier (name) of the interface.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_interface_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_interface_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: The identifier (name) of the interface.
	...
	/// Build a [`TSInterfaceDeclaration`] with `ScopeId`, and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_interface_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: The identifier (name) of the interface.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_interface_body`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_interface_body`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - body
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_property_signature`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - computed
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_property_signature`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - computed
	...
	///
	/// This node contains a [`TSPropertySignature`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSCallSignatureDeclaration`] that will be stored
	/// in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSConstructSignatureDeclaration`] that will be
	/// stored in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSMethodSignature`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_index_signature`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - parameters
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_index_signature`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - parameters
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_call_signature_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameters
	...
	/// Build a [`TSCallSignatureDeclaration`], and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_call_signature_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_method_signature`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_method_signature`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_method_signature_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	/// Build a [`TSMethodSignature`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_method_signature_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - key
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_construct_signature_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameters
	...
	/// Build a [`TSConstructSignatureDeclaration`], and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_construct_signature_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameters
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_construct_signature_declaration_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	/// Build a [`TSConstructSignatureDeclaration`] with `ScopeId`, and store it
	/// in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_construct_signature_declaration_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_index_signature_name`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_index_signature_name`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_interface_heritage`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_interface_heritage`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_predicate`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - parameter_name: The identifier the predicate operates on
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_predicate`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - parameter_name: The identifier the predicate operates on
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_module_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: The name of the module/namespace being declared.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_module_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: The name of the module/namespace being declared.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_module_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: The name of the module/namespace being declared.
	...
	/// Build a [`TSModuleDeclaration`] with `ScopeId`, and store it in the
	/// memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_module_declaration_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id: The name of the module/namespace being declared.
	...
	///
	/// This node contains a [`TSModuleBlock`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_module_block`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - directives
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_module_block`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - directives
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_literal`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - members
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_literal`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - members
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_infer_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameter: The type bound when the
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_infer_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameter: The type bound when the
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_query`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expr_name
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_query`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expr_name
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_import_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - is_type_of: `true` for `typeof import("foo")`
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_import_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - is_type_of: `true` for `typeof import("foo")`
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_import_attributes`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - attributes_keyword
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_import_attributes`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - attributes_keyword
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_import_attribute`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_import_attribute`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - name
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_function_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameters: Generic type parameters
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_function_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameters: Generic type parameters
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_constructor_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#abstract
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_constructor_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - r#abstract
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_mapped_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameter: Key type parameter, e.g. `P` in `[P in keyof T]`.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_mapped_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameter: Key type parameter, e.g. `P` in `[P in keyof T]`.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_mapped_type_with_scope_id`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_parameter: Key type parameter, e.g. `P` in `[P in keyof T]`.
	...
	/// Build a [`TSMappedType`] with `ScopeId`, and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_mapped_type_with_scope_id`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_template_literal_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - quasis: The string parts of the template literal.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_template_literal_type`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_as_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_as_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_satisfies_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression: The value expression being constrained.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_satisfies_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_type_assertion`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_type_assertion`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_import_equals_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_import_equals_declaration`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// This node contains a [`TSExternalModuleReference`] that will be stored
	/// in the memory arena.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_external_module_reference`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_external_module_reference`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_non_null_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_non_null_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_decorator`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::decorator`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_export_assignment`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_export_assignment`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_namespace_export_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	/// Build a [`TSNamespaceExportDeclaration`], and store it in the memory
	/// arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use
	/// [`AstBuilder::ts_namespace_export_declaration`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - id
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_ts_instantiation_expression`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - expression
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::ts_instantiation_expression`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_js_doc_nullable_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::js_doc_nullable_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_js_doc_non_nullable_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	/// - type_annotation
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::js_doc_non_nullable_type`]
	/// instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_js_doc_unknown_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	pub fn js_doc_unknown_type(self, span:Span) -> JSDocUnknownType { JSDocUnknownType { span } }

	/// Build a [`JSDocUnknownType`], and store it in the memory arena.
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::js_doc_unknown_type`] instead.
	///
	/// ## Parameters
	/// - span: The [`Span`] covering this node
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_element`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - opening_element: Opening tag of the element.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_element`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - opening_element: Opening tag of the element.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_opening_element`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - self_closing: Is this tag self-closing?
	/// - name: The possibly-namespaced tag name, e.g. `Foo` in `<Foo />`.
	/// - attributes: List of JSX attributes. In React-like applications, these
	///   become props.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_opening_element`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - self_closing: Is this tag self-closing?
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_closing_element`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_closing_element`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - name: The tag name, e.g. `Foo` in `</Foo>`.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_fragment`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - opening_fragment: `<>`
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_fragment`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - opening_fragment: `<>`
	...
	///
	/// This node contains a [`JSXIdentifier`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`JSXNamespacedName`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`JSXMemberExpression`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///   `.`.
	/// - property: The property being accessed. This is everything after the
	///   last `.`.
	#[inline]
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_namespaced_name`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - namespace: Namespace portion of the name, e.g. `Apple` in
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_namespaced_name`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - namespace: Namespace portion of the name, e.g. `Apple` in
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_member_expression`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - object: The object being accessed. This is everything before the last
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_member_expression`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - object: The object being accessed. This is everything before the last
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_expression_container`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_expression_container`]
	/// instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_empty_expression`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	#[inline]
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_empty_expression`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	#[inline]
	...
	///
	/// This node contains a [`JSXAttribute`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - name: The name of the attribute. This is a prop in React-like
	///   applications.
	/// - value: The value of the attribute. This can be a string literal, an
	///   expression,
	#[inline]
	...
	///
	/// This node contains a [`JSXSpreadAttribute`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_attribute`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - name: The name of the attribute. This is a prop in React-like
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_attribute`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - name: The name of the attribute. This is a prop in React-like
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_spread_attribute`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - argument: The expression being spread.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_spread_attribute`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - argument: The expression being spread.
	...
	///
	/// This node contains a [`JSXExpressionContainer`] that will be stored in
	/// the memory arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_identifier`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - name: The name of the identifier.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_identifier`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - name: The name of the identifier.
	...
	///
	/// This node contains a [`JSXText`] that will be stored in the memory
	/// arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// This node contains a [`JSXSpreadChild`] that will be stored in the
	/// memory arena.
	///
	/// ## Parameters
	/// - span: Node location in source code
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_spread_child`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - expression: The expression being spread.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_spread_child`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - expression: The expression being spread.
	...
	///
	/// If you want the built node to be allocated in the memory arena, use
	/// [`AstBuilder::alloc_jsx_text`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - value: The text content.
	...
	///
	/// Returns a [`Box`] containing the newly-allocated node. If you want a
	/// stack-allocated node, use [`AstBuilder::jsx_text`] instead.
	///
	/// ## Parameters
	/// - span: Node location in source code
	/// - value: The text content.
