...
use crate::ast::{comment::*, js::*, jsx::*, literal::*, ts::*};

impl ContentEq for BooleanLiteral {
	fn content_eq(&self, other:&Self) -> bool { ContentEq::content_eq(&self.value, &other.value) }
}
	...
	fn content_eq(&self, other:&Self) -> bool {
		match self {
			...
			Self::ArrowFunctionExpression(it) => {
				match other {
					Self::ArrowFunctionExpression(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
			...
			Self::ParenthesizedExpression(it) => {
				match other {
					Self::ParenthesizedExpression(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
			...
			Self::TaggedTemplateExpression(it) => {
				match other {
					Self::TaggedTemplateExpression(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
			...
			Self::TSInstantiationExpression(it) => {
				match other {
					Self::TSInstantiationExpression(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
			...
			Self::ComputedMemberExpression(it) => {
				match other {
					Self::ComputedMemberExpression(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
	...
	fn content_eq(&self, other:&Self) -> bool {
		match self {
			Self::AssignmentTargetIdentifier(it) => {
				match other {
					Self::AssignmentTargetIdentifier(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
...
impl ContentEq for AssignmentTargetRest<'_> {
	fn content_eq(&self, other:&Self) -> bool { ContentEq::content_eq(&self.target, &other.target) }
}
	...
	fn content_eq(&self, other:&Self) -> bool {
		match self {
			Self::AssignmentTargetWithDefault(it) => {
				match other {
					Self::AssignmentTargetWithDefault(other)
	...
	fn content_eq(&self, other:&Self) -> bool {
		match self {
			...
			Self::TSImportEqualsDeclaration(it) => {
				match other {
					Self::TSImportEqualsDeclaration(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
			...
			Self::ExportDefaultDeclaration(it) => {
				match other {
					Self::ExportDefaultDeclaration(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
			...
			Self::TSNamespaceExportDeclaration(it) => {
				match other {
					Self::TSNamespaceExportDeclaration(other)
						if ContentEq::content_eq(it, other) =>
					{
						true
					},
...
impl ContentEq for ContinueStatement<'_> {
	fn content_eq(&self, other:&Self) -> bool { ContentEq::content_eq(&self.label, &other.label) }
}
	...
	fn content_eq(&self, other:&Self) -> bool {
		match self {
			...
			Self::ImportNamespaceSpecifier(it) => {
				match other {
					Self::ImportNamespaceSpecifier(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
...
impl ContentEq for ImportDefaultSpecifier<'_> {
	fn content_eq(&self, other:&Self) -> bool { ContentEq::content_eq(&self.local, &other.local) }
}
...
impl ContentEq for TSUnionType<'_> {
	fn content_eq(&self, other:&Self) -> bool { ContentEq::content_eq(&self.types, &other.types) }
}
...
impl ContentEq for TSTypeParameterInstantiation<'_> {
	fn content_eq(&self, other:&Self) -> bool { ContentEq::content_eq(&self.params, &other.params) }
}
	...
	fn content_eq(&self, other:&Self) -> bool {
		match self {
			...
			Self::TSCallSignatureDeclaration(it) => {
				match other {
					Self::TSCallSignatureDeclaration(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
	...
	fn content_eq(&self, other:&Self) -> bool {
		match self {
			Self::ExternalModuleReference(it) => {
				match other {
					Self::ExternalModuleReference(other) if ContentEq::content_eq(it, other) => {
						true
					},
					_ => false,
				}
...
impl ContentEq for TSNamespaceExportDeclaration<'_> {
	fn content_eq(&self, other:&Self) -> bool { ContentEq::content_eq(&self.id, &other.id) }
}
