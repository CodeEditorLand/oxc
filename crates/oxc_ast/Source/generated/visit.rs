...
pub trait Visit<'a>: Sized {
	...
	#[inline]
	fn visit_hashbang(&mut self, it:&Hashbang<'a>) { walk_hashbang(self, it); }

	#[inline]
	fn visit_directives(&mut self, it:&Vec<'a, Directive<'a>>) { walk_directives(self, it); }

	#[inline]
	fn visit_directive(&mut self, it:&Directive<'a>) { walk_directive(self, it); }

	#[inline]
	fn visit_string_literal(&mut self, it:&StringLiteral<'a>) { walk_string_literal(self, it); }

	#[inline]
	fn visit_statements(&mut self, it:&Vec<'a, Statement<'a>>) { walk_statements(self, it); }

	#[inline]
	fn visit_statement(&mut self, it:&Statement<'a>) { walk_statement(self, it); }

	#[inline]
	fn visit_block_statement(&mut self, it:&BlockStatement<'a>) { walk_block_statement(self, it); }

	#[inline]
	fn visit_break_statement(&mut self, it:&BreakStatement<'a>) { walk_break_statement(self, it); }
	...
	#[inline]
	fn visit_expression(&mut self, it:&Expression<'a>) { walk_expression(self, it); }

	#[inline]
	fn visit_boolean_literal(&mut self, it:&BooleanLiteral) { walk_boolean_literal(self, it); }

	#[inline]
	fn visit_null_literal(&mut self, it:&NullLiteral) { walk_null_literal(self, it); }

	#[inline]
	fn visit_numeric_literal(&mut self, it:&NumericLiteral<'a>) { walk_numeric_literal(self, it); }

	#[inline]
	fn visit_big_int_literal(&mut self, it:&BigIntLiteral<'a>) { walk_big_int_literal(self, it); }

	#[inline]
	fn visit_reg_exp_literal(&mut self, it:&RegExpLiteral<'a>) { walk_reg_exp_literal(self, it); }
	...
	#[inline]
	fn visit_expressions(&mut self, it:&Vec<'a, Expression<'a>>) { walk_expressions(self, it); }
	...
	#[inline]
	fn visit_meta_property(&mut self, it:&MetaProperty<'a>) { walk_meta_property(self, it); }

	#[inline]
	fn visit_identifier_name(&mut self, it:&IdentifierName<'a>) { walk_identifier_name(self, it); }

	#[inline]
	fn visit_super(&mut self, it:&Super) { walk_super(self, it); }
	...
	#[inline]
	fn visit_spread_element(&mut self, it:&SpreadElement<'a>) { walk_spread_element(self, it); }

	#[inline]
	fn visit_elision(&mut self, it:&Elision) { walk_elision(self, it); }
	...
	#[inline]
	fn visit_ts_type(&mut self, it:&TSType<'a>) { walk_ts_type(self, it); }

	#[inline]
	fn visit_ts_any_keyword(&mut self, it:&TSAnyKeyword) { walk_ts_any_keyword(self, it); }
	...
	#[inline]
	fn visit_ts_never_keyword(&mut self, it:&TSNeverKeyword) { walk_ts_never_keyword(self, it); }

	#[inline]
	fn visit_ts_null_keyword(&mut self, it:&TSNullKeyword) { walk_ts_null_keyword(self, it); }

	#[inline]
	fn visit_ts_number_keyword(&mut self, it:&TSNumberKeyword) { walk_ts_number_keyword(self, it); }

	#[inline]
	fn visit_ts_object_keyword(&mut self, it:&TSObjectKeyword) { walk_ts_object_keyword(self, it); }

	#[inline]
	fn visit_ts_string_keyword(&mut self, it:&TSStringKeyword) { walk_ts_string_keyword(self, it); }

	#[inline]
	fn visit_ts_symbol_keyword(&mut self, it:&TSSymbolKeyword) { walk_ts_symbol_keyword(self, it); }
	...
	#[inline]
	fn visit_ts_void_keyword(&mut self, it:&TSVoidKeyword) { walk_ts_void_keyword(self, it); }

	#[inline]
	fn visit_ts_array_type(&mut self, it:&TSArrayType<'a>) { walk_ts_array_type(self, it); }
	...
	#[inline]
	fn visit_decorators(&mut self, it:&Vec<'a, Decorator<'a>>) { walk_decorators(self, it); }

	#[inline]
	fn visit_decorator(&mut self, it:&Decorator<'a>) { walk_decorator(self, it); }

	#[inline]
	fn visit_binding_pattern(&mut self, it:&BindingPattern<'a>) { walk_binding_pattern(self, it); }
	...
	#[inline]
	fn visit_object_pattern(&mut self, it:&ObjectPattern<'a>) { walk_object_pattern(self, it); }
	...
	#[inline]
	fn visit_property_key(&mut self, it:&PropertyKey<'a>) { walk_property_key(self, it); }
	...
	#[inline]
	fn visit_array_pattern(&mut self, it:&ArrayPattern<'a>) { walk_array_pattern(self, it); }
	...
	#[inline]
	fn visit_ts_import_type(&mut self, it:&TSImportType<'a>) { walk_ts_import_type(self, it); }

	#[inline]
	fn visit_ts_type_name(&mut self, it:&TSTypeName<'a>) { walk_ts_type_name(self, it); }
	...
	#[inline]
	fn visit_ts_types(&mut self, it:&Vec<'a, TSType<'a>>) { walk_ts_types(self, it); }
	...
	#[inline]
	fn visit_ts_infer_type(&mut self, it:&TSInferType<'a>) { walk_ts_infer_type(self, it); }
	...
	#[inline]
	fn visit_ts_literal_type(&mut self, it:&TSLiteralType<'a>) { walk_ts_literal_type(self, it); }

	#[inline]
	fn visit_ts_literal(&mut self, it:&TSLiteral<'a>) { walk_ts_literal(self, it); }
	...
	#[inline]
	fn visit_ts_mapped_type(&mut self, it:&TSMappedType<'a>) { walk_ts_mapped_type(self, it); }
	...
	#[inline]
	fn visit_ts_rest_type(&mut self, it:&TSRestType<'a>) { walk_ts_rest_type(self, it); }
	...
	#[inline]
	fn visit_ts_this_type(&mut self, it:&TSThisType) { walk_ts_this_type(self, it); }

	#[inline]
	fn visit_ts_tuple_type(&mut self, it:&TSTupleType<'a>) { walk_ts_tuple_type(self, it); }
	...
	#[inline]
	fn visit_ts_type_literal(&mut self, it:&TSTypeLiteral<'a>) { walk_ts_type_literal(self, it); }
	...
	#[inline]
	fn visit_ts_signature(&mut self, it:&TSSignature<'a>) { walk_ts_signature(self, it); }
	...
	#[inline]
	fn visit_ts_type_query(&mut self, it:&TSTypeQuery<'a>) { walk_ts_type_query(self, it); }
	...
	#[inline]
	fn visit_ts_union_type(&mut self, it:&TSUnionType<'a>) { walk_ts_union_type(self, it); }
	...
	#[inline]
	fn visit_function_body(&mut self, it:&FunctionBody<'a>) { walk_function_body(self, it); }
	...
	#[inline]
	fn visit_call_expression(&mut self, it:&CallExpression<'a>) { walk_call_expression(self, it); }

	#[inline]
	fn visit_arguments(&mut self, it:&Vec<'a, Argument<'a>>) { walk_arguments(self, it); }

	#[inline]
	fn visit_argument(&mut self, it:&Argument<'a>) { walk_argument(self, it); }
	...
	#[inline]
	fn visit_chain_element(&mut self, it:&ChainElement<'a>) { walk_chain_element(self, it); }

	#[inline]
	fn visit_class(&mut self, it:&Class<'a>) { walk_class(self, it); }

	#[inline]
	fn visit_class_heritage(&mut self, it:&Expression<'a>) { walk_class_heritage(self, it); }
	...
	#[inline]
	fn visit_class_body(&mut self, it:&ClassBody<'a>) { walk_class_body(self, it); }
	...
	#[inline]
	fn visit_class_element(&mut self, it:&ClassElement<'a>) { walk_class_element(self, it); }

	#[inline]
	fn visit_static_block(&mut self, it:&StaticBlock<'a>) { walk_static_block(self, it); }
	...
	#[inline]
	fn visit_new_expression(&mut self, it:&NewExpression<'a>) { walk_new_expression(self, it); }
	...
	#[inline]
	fn visit_object_property(&mut self, it:&ObjectProperty<'a>) { walk_object_property(self, it); }
	...
	#[inline]
	fn visit_this_expression(&mut self, it:&ThisExpression) { walk_this_expression(self, it); }
	...
	#[inline]
	fn visit_jsx_element(&mut self, it:&JSXElement<'a>) { walk_jsx_element(self, it); }
	...
	#[inline]
	fn visit_jsx_identifier(&mut self, it:&JSXIdentifier<'a>) { walk_jsx_identifier(self, it); }
	...
	#[inline]
	fn visit_jsx_attribute(&mut self, it:&JSXAttribute<'a>) { walk_jsx_attribute(self, it); }
	...
	#[inline]
	fn visit_jsx_expression(&mut self, it:&JSXExpression<'a>) { walk_jsx_expression(self, it); }
	...
	#[inline]
	fn visit_jsx_fragment(&mut self, it:&JSXFragment<'a>) { walk_jsx_fragment(self, it); }

	#[inline]
	fn visit_jsx_children(&mut self, it:&Vec<'a, JSXChild<'a>>) { walk_jsx_children(self, it); }

	#[inline]
	fn visit_jsx_child(&mut self, it:&JSXChild<'a>) { walk_jsx_child(self, it); }

	#[inline]
	fn visit_jsx_text(&mut self, it:&JSXText<'a>) { walk_jsx_text(self, it); }
	...
	#[inline]
	fn visit_empty_statement(&mut self, it:&EmptyStatement) { walk_empty_statement(self, it); }
	...
	#[inline]
	fn visit_for_statement(&mut self, it:&ForStatement<'a>) { walk_for_statement(self, it); }
	...
	#[inline]
	fn visit_if_statement(&mut self, it:&IfStatement<'a>) { walk_if_statement(self, it); }
	...
	#[inline]
	fn visit_switch_cases(&mut self, it:&Vec<'a, SwitchCase<'a>>) { walk_switch_cases(self, it); }

	#[inline]
	fn visit_switch_case(&mut self, it:&SwitchCase<'a>) { walk_switch_case(self, it); }

	#[inline]
	fn visit_throw_statement(&mut self, it:&ThrowStatement<'a>) { walk_throw_statement(self, it); }

	#[inline]
	fn visit_try_statement(&mut self, it:&TryStatement<'a>) { walk_try_statement(self, it); }

	#[inline]
	fn visit_catch_clause(&mut self, it:&CatchClause<'a>) { walk_catch_clause(self, it); }

	#[inline]
	fn visit_catch_parameter(&mut self, it:&CatchParameter<'a>) { walk_catch_parameter(self, it); }

	#[inline]
	fn visit_finally_clause(&mut self, it:&BlockStatement<'a>) { walk_finally_clause(self, it); }

	#[inline]
	fn visit_while_statement(&mut self, it:&WhileStatement<'a>) { walk_while_statement(self, it); }

	#[inline]
	fn visit_with_statement(&mut self, it:&WithStatement<'a>) { walk_with_statement(self, it); }

	#[inline]
	fn visit_declaration(&mut self, it:&Declaration<'a>) { walk_declaration(self, it); }
	...
	#[inline]
	fn visit_ts_enum_member(&mut self, it:&TSEnumMember<'a>) { walk_ts_enum_member(self, it); }
	...
	#[inline]
	fn visit_ts_module_block(&mut self, it:&TSModuleBlock<'a>) { walk_ts_module_block(self, it); }
	...
	#[inline]
	fn visit_with_clause(&mut self, it:&WithClause<'a>) { walk_with_clause(self, it); }
...
pub mod walk {
	...
	#[inline]
	pub fn walk_identifier_reference<'a, V:Visit<'a>>(visitor:&mut V, it:&IdentifierReference<'a>) {
	...
	#[inline]
	pub fn walk_binding_pattern_kind<'a, V:Visit<'a>>(visitor:&mut V, it:&BindingPatternKind<'a>) {
		match it {
	...
	#[inline]
	pub fn walk_binding_rest_element<'a, V:Visit<'a>>(visitor:&mut V, it:&BindingRestElement<'a>) {
	...
	#[inline]
	pub fn walk_ts_import_attributes<'a, V:Visit<'a>>(visitor:&mut V, it:&TSImportAttributes<'a>) {
		// NOTE: AstKind doesn't exists!
	...
	#[inline]
	pub fn walk_ts_intersection_type<'a, V:Visit<'a>>(visitor:&mut V, it:&TSIntersectionType<'a>) {
	...
	#[inline]
	pub fn walk_ts_named_tuple_member<'a, V:Visit<'a>>(visitor:&mut V, it:&TSNamedTupleMember<'a>) {
	...
	#[inline]
	pub fn walk_js_doc_nullable_type<'a, V:Visit<'a>>(visitor:&mut V, it:&JSDocNullableType<'a>) {
		// NOTE: AstKind doesn't exists!
		visitor.visit_ts_type(&it.type_annotation);
	}
	...
	#[inline]
	pub fn walk_property_definition<'a, V:Visit<'a>>(visitor:&mut V, it:&PropertyDefinition<'a>) {
	...
	#[inline]
	pub fn walk_object_property_kind<'a, V:Visit<'a>>(visitor:&mut V, it:&ObjectPropertyKind<'a>) {
		match it {
	...
	#[inline]
	pub fn walk_sequence_expression<'a, V:Visit<'a>>(visitor:&mut V, it:&SequenceExpression<'a>) {
	...
	#[inline]
	pub fn walk_jsx_spread_attribute<'a, V:Visit<'a>>(visitor:&mut V, it:&JSXSpreadAttribute<'a>) {
	...
	#[inline]
	pub fn walk_expression_statement<'a, V:Visit<'a>>(visitor:&mut V, it:&ExpressionStatement<'a>) {
	...
	#[inline]
	pub fn walk_variable_declaration<'a, V:Visit<'a>>(visitor:&mut V, it:&VariableDeclaration<'a>) {
	...
	#[inline]
	pub fn walk_variable_declarator<'a, V:Visit<'a>>(visitor:&mut V, it:&VariableDeclarator<'a>) {
	...
	#[inline]
	pub fn walk_import_attribute_key<'a, V:Visit<'a>>(visitor:&mut V, it:&ImportAttributeKey<'a>) {
		match it {
	...
	#[inline]
	pub fn walk_ts_export_assignment<'a, V:Visit<'a>>(visitor:&mut V, it:&TSExportAssignment<'a>) {
