...
pub trait VisitMut<'a>: Sized {
	...
	#[inline]
	fn visit_program(&mut self, it:&mut Program<'a>) { walk_program(self, it); }

	#[inline]
	fn visit_hashbang(&mut self, it:&mut Hashbang<'a>) { walk_hashbang(self, it); }

	#[inline]
	fn visit_directives(&mut self, it:&mut Vec<'a, Directive<'a>>) { walk_directives(self, it); }

	#[inline]
	fn visit_directive(&mut self, it:&mut Directive<'a>) { walk_directive(self, it); }

	#[inline]
	fn visit_string_literal(&mut self, it:&mut StringLiteral<'a>) { walk_string_literal(self, it); }

	#[inline]
	fn visit_statements(&mut self, it:&mut Vec<'a, Statement<'a>>) { walk_statements(self, it); }

	#[inline]
	fn visit_statement(&mut self, it:&mut Statement<'a>) { walk_statement(self, it); }
	...
	#[inline]
	fn visit_expression(&mut self, it:&mut Expression<'a>) { walk_expression(self, it); }

	#[inline]
	fn visit_boolean_literal(&mut self, it:&mut BooleanLiteral) { walk_boolean_literal(self, it); }

	#[inline]
	fn visit_null_literal(&mut self, it:&mut NullLiteral) { walk_null_literal(self, it); }
	...
	#[inline]
	fn visit_expressions(&mut self, it:&mut Vec<'a, Expression<'a>>) { walk_expressions(self, it); }
	...
	#[inline]
	fn visit_meta_property(&mut self, it:&mut MetaProperty<'a>) { walk_meta_property(self, it); }
	...
	#[inline]
	fn visit_super(&mut self, it:&mut Super) { walk_super(self, it); }
	...
	#[inline]
	fn visit_spread_element(&mut self, it:&mut SpreadElement<'a>) { walk_spread_element(self, it); }

	#[inline]
	fn visit_elision(&mut self, it:&mut Elision) { walk_elision(self, it); }
	...
	#[inline]
	fn visit_ts_type(&mut self, it:&mut TSType<'a>) { walk_ts_type(self, it); }

	#[inline]
	fn visit_ts_any_keyword(&mut self, it:&mut TSAnyKeyword) { walk_ts_any_keyword(self, it); }
	...
	#[inline]
	fn visit_ts_null_keyword(&mut self, it:&mut TSNullKeyword) { walk_ts_null_keyword(self, it); }
	...
	#[inline]
	fn visit_ts_void_keyword(&mut self, it:&mut TSVoidKeyword) { walk_ts_void_keyword(self, it); }

	#[inline]
	fn visit_ts_array_type(&mut self, it:&mut TSArrayType<'a>) { walk_ts_array_type(self, it); }
	...
	#[inline]
	fn visit_decorators(&mut self, it:&mut Vec<'a, Decorator<'a>>) { walk_decorators(self, it); }

	#[inline]
	fn visit_decorator(&mut self, it:&mut Decorator<'a>) { walk_decorator(self, it); }
	...
	#[inline]
	fn visit_object_pattern(&mut self, it:&mut ObjectPattern<'a>) { walk_object_pattern(self, it); }
	...
	#[inline]
	fn visit_property_key(&mut self, it:&mut PropertyKey<'a>) { walk_property_key(self, it); }
	...
	#[inline]
	fn visit_array_pattern(&mut self, it:&mut ArrayPattern<'a>) { walk_array_pattern(self, it); }
	...
	#[inline]
	fn visit_ts_import_type(&mut self, it:&mut TSImportType<'a>) { walk_ts_import_type(self, it); }

	#[inline]
	fn visit_ts_type_name(&mut self, it:&mut TSTypeName<'a>) { walk_ts_type_name(self, it); }
	...
	#[inline]
	fn visit_ts_types(&mut self, it:&mut Vec<'a, TSType<'a>>) { walk_ts_types(self, it); }
	...
	#[inline]
	fn visit_ts_infer_type(&mut self, it:&mut TSInferType<'a>) { walk_ts_infer_type(self, it); }
	...
	#[inline]
	fn visit_ts_literal(&mut self, it:&mut TSLiteral<'a>) { walk_ts_literal(self, it); }
	...
	#[inline]
	fn visit_ts_mapped_type(&mut self, it:&mut TSMappedType<'a>) { walk_ts_mapped_type(self, it); }
	...
	#[inline]
	fn visit_ts_rest_type(&mut self, it:&mut TSRestType<'a>) { walk_ts_rest_type(self, it); }
	...
	#[inline]
	fn visit_ts_this_type(&mut self, it:&mut TSThisType) { walk_ts_this_type(self, it); }

	#[inline]
	fn visit_ts_tuple_type(&mut self, it:&mut TSTupleType<'a>) { walk_ts_tuple_type(self, it); }
	...
	#[inline]
	fn visit_ts_signature(&mut self, it:&mut TSSignature<'a>) { walk_ts_signature(self, it); }
	...
	#[inline]
	fn visit_ts_type_query(&mut self, it:&mut TSTypeQuery<'a>) { walk_ts_type_query(self, it); }
	...
	#[inline]
	fn visit_ts_union_type(&mut self, it:&mut TSUnionType<'a>) { walk_ts_union_type(self, it); }
	...
	#[inline]
	fn visit_function_body(&mut self, it:&mut FunctionBody<'a>) { walk_function_body(self, it); }
	...
	#[inline]
	fn visit_arguments(&mut self, it:&mut Vec<'a, Argument<'a>>) { walk_arguments(self, it); }

	#[inline]
	fn visit_argument(&mut self, it:&mut Argument<'a>) { walk_argument(self, it); }
	...
	#[inline]
	fn visit_chain_element(&mut self, it:&mut ChainElement<'a>) { walk_chain_element(self, it); }

	#[inline]
	fn visit_class(&mut self, it:&mut Class<'a>) { walk_class(self, it); }

	#[inline]
	fn visit_class_heritage(&mut self, it:&mut Expression<'a>) { walk_class_heritage(self, it); }
	...
	#[inline]
	fn visit_class_body(&mut self, it:&mut ClassBody<'a>) { walk_class_body(self, it); }
	...
	#[inline]
	fn visit_class_element(&mut self, it:&mut ClassElement<'a>) { walk_class_element(self, it); }

	#[inline]
	fn visit_static_block(&mut self, it:&mut StaticBlock<'a>) { walk_static_block(self, it); }
	...
	#[inline]
	fn visit_new_expression(&mut self, it:&mut NewExpression<'a>) { walk_new_expression(self, it); }
	...
	#[inline]
	fn visit_this_expression(&mut self, it:&mut ThisExpression) { walk_this_expression(self, it); }
	...
	#[inline]
	fn visit_jsx_element(&mut self, it:&mut JSXElement<'a>) { walk_jsx_element(self, it); }
	...
	#[inline]
	fn visit_jsx_identifier(&mut self, it:&mut JSXIdentifier<'a>) { walk_jsx_identifier(self, it); }
	...
	#[inline]
	fn visit_jsx_attribute(&mut self, it:&mut JSXAttribute<'a>) { walk_jsx_attribute(self, it); }
	...
	#[inline]
	fn visit_jsx_expression(&mut self, it:&mut JSXExpression<'a>) { walk_jsx_expression(self, it); }
	...
	#[inline]
	fn visit_jsx_fragment(&mut self, it:&mut JSXFragment<'a>) { walk_jsx_fragment(self, it); }

	#[inline]
	fn visit_jsx_children(&mut self, it:&mut Vec<'a, JSXChild<'a>>) { walk_jsx_children(self, it); }

	#[inline]
	fn visit_jsx_child(&mut self, it:&mut JSXChild<'a>) { walk_jsx_child(self, it); }

	#[inline]
	fn visit_jsx_text(&mut self, it:&mut JSXText<'a>) { walk_jsx_text(self, it); }
	...
	#[inline]
	fn visit_empty_statement(&mut self, it:&mut EmptyStatement) { walk_empty_statement(self, it); }
	...
	#[inline]
	fn visit_for_statement(&mut self, it:&mut ForStatement<'a>) { walk_for_statement(self, it); }
	...
	#[inline]
	fn visit_if_statement(&mut self, it:&mut IfStatement<'a>) { walk_if_statement(self, it); }
	...
	#[inline]
	fn visit_switch_case(&mut self, it:&mut SwitchCase<'a>) { walk_switch_case(self, it); }
	...
	#[inline]
	fn visit_try_statement(&mut self, it:&mut TryStatement<'a>) { walk_try_statement(self, it); }

	#[inline]
	fn visit_catch_clause(&mut self, it:&mut CatchClause<'a>) { walk_catch_clause(self, it); }
	...
	#[inline]
	fn visit_with_statement(&mut self, it:&mut WithStatement<'a>) { walk_with_statement(self, it); }

	#[inline]
	fn visit_declaration(&mut self, it:&mut Declaration<'a>) { walk_declaration(self, it); }
	...
	#[inline]
	fn visit_ts_enum_member(&mut self, it:&mut TSEnumMember<'a>) { walk_ts_enum_member(self, it); }
	...
	#[inline]
	fn visit_with_clause(&mut self, it:&mut WithClause<'a>) { walk_with_clause(self, it); }
...
pub mod walk_mut {
	...
	#[inline]
	pub fn walk_label_identifier<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut LabelIdentifier<'a>) {
	...
	#[inline]
	pub fn walk_debugger_statement<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut DebuggerStatement) {
	...
	#[inline]
	pub fn walk_template_literal<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TemplateLiteral<'a>) {
	...
	#[inline]
	pub fn walk_template_element<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TemplateElement<'a>) {
		// NOTE: AstType doesn't exists!
	}

	#[inline]
	pub fn walk_expressions<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut Vec<'a, Expression<'a>>) {
		for el in it.iter_mut() {
	...
	#[inline]
	pub fn walk_array_expression<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ArrayExpression<'a>) {
	...
	#[inline]
	pub fn walk_ts_type_parameter<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSTypeParameter<'a>) {
	...
	#[inline]
	pub fn walk_ts_boolean_keyword<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSBooleanKeyword) {
	...
	#[inline]
	pub fn walk_ts_unknown_keyword<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSUnknownKeyword) {
	...
	#[inline]
	pub fn walk_formal_parameter<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut FormalParameter<'a>) {
	...
	#[inline]
	pub fn walk_binding_property<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut BindingProperty<'a>) {
		// NOTE: AstType doesn't exists!
	...
	#[inline]
	pub fn walk_ts_function_type<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSFunctionType<'a>) {
		// NOTE: AstType doesn't exists!
	...
	#[inline]
	pub fn walk_ts_this_parameter<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSThisParameter<'a>) {
	...
	#[inline]
	pub fn walk_ts_qualified_name<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSQualifiedName<'a>) {
	...
	#[inline]
	pub fn walk_unary_expression<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut UnaryExpression<'a>) {
	...
	#[inline]
	pub fn walk_ts_tuple_element<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSTupleElement<'a>) {
		match it {
	...
	#[inline]
	pub fn walk_ts_optional_type<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSOptionalType<'a>) {
		// NOTE: AstType doesn't exists!
		visitor.visit_ts_type(&mut it.type_annotation);
	}
	...
	#[inline]
	pub fn walk_ts_type_operator<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSTypeOperator<'a>) {
		// NOTE: AstType doesn't exists!
		visitor.visit_ts_type(&mut it.type_annotation);
	}

	#[inline]
	pub fn walk_ts_type_predicate<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSTypePredicate<'a>) {
		// NOTE: AstType doesn't exists!
	...
	#[inline]
	pub fn walk_ts_type_reference<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSTypeReference<'a>) {
	...
	#[inline]
	pub fn walk_js_doc_unknown_type<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut JSDocUnknownType) {
		// NOTE: AstType doesn't exists!
	}
	...
	#[inline]
	pub fn walk_ts_as_expression<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSAsExpression<'a>) {
	...
	#[inline]
	pub fn walk_ts_type_assertion<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSTypeAssertion<'a>) {
	...
	#[inline]
	pub fn walk_await_expression<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut AwaitExpression<'a>) {
	...
	#[inline]
	pub fn walk_chain_expression<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ChainExpression<'a>) {
	...
	#[inline]
	pub fn walk_yield_expression<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut YieldExpression<'a>) {
	...
	#[inline]
	pub fn walk_jsx_element_name<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut JSXElementName<'a>) {
	...
	#[inline]
	pub fn walk_jsx_spread_child<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut JSXSpreadChild<'a>) {
		// NOTE: AstType doesn't exists!
		visitor.visit_expression(&mut it.expression);
	}
	...
	#[inline]
	pub fn walk_for_in_statement<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ForInStatement<'a>) {
	...
	#[inline]
	pub fn walk_for_of_statement<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ForOfStatement<'a>) {
	...
	#[inline]
	pub fn walk_return_statement<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ReturnStatement<'a>) {
	...
	#[inline]
	pub fn walk_switch_statement<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut SwitchStatement<'a>) {
	...
	#[inline]
	pub fn walk_switch_cases<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut Vec<'a, SwitchCase<'a>>) {
		for el in it.iter_mut() {
	...
	#[inline]
	pub fn walk_ts_interface_body<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut TSInterfaceBody<'a>) {
		// NOTE: AstType doesn't exists!
	...
	#[inline]
	pub fn walk_import_specifier<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ImportSpecifier<'a>) {
	...
	#[inline]
	pub fn walk_import_attribute<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ImportAttribute<'a>) {
		// NOTE: AstType doesn't exists!
	...
	#[inline]
	pub fn walk_export_specifier<'a, V:VisitMut<'a>>(visitor:&mut V, it:&mut ExportSpecifier<'a>) {
