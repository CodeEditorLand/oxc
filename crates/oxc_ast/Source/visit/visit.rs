...
pub trait Visit<'a>: Sized {
	...
	fn visit_program(&mut self, program:&Program<'a>) { walk_program(self, program); }

	// ----------  Statement ----------

	fn visit_statements(&mut self, stmts:&Vec<'a, Statement<'a>>) { walk_statements(self, stmts); }

	fn visit_statement(&mut self, stmt:&Statement<'a>) { walk_statement(self, stmt); }
	...
	fn visit_empty_statement(&mut self, stmt:&EmptyStatement) { walk_empty_statement(self, stmt); }

	fn visit_expression_statement(&mut self, stmt:&ExpressionStatement<'a>) {
		walk_expression_statement(self, stmt);
	}

	fn visit_for_statement(&mut self, stmt:&ForStatement<'a>) { walk_for_statement(self, stmt); }
	...
	fn visit_if_statement(&mut self, stmt:&IfStatement<'a>) { walk_if_statement(self, stmt); }
	...
	fn visit_switch_case(&mut self, case:&SwitchCase<'a>) { walk_switch_case(self, case); }

	fn visit_throw_statement(&mut self, stmt:&ThrowStatement<'a>) {
		walk_throw_statement(self, stmt);
	}

	fn visit_try_statement(&mut self, stmt:&TryStatement<'a>) { walk_try_statement(self, stmt); }

	fn visit_catch_clause(&mut self, clause:&CatchClause<'a>) { walk_catch_clause(self, clause); }
	...
	fn visit_with_statement(&mut self, stmt:&WithStatement<'a>) { walk_with_statement(self, stmt); }

	fn visit_directive(&mut self, directive:&Directive<'a>) { walk_directive(self, directive); }
	...
	fn visit_function_body(&mut self, body:&FunctionBody<'a>) { walk_function_body(self, body); }
	...
	fn visit_decorator(&mut self, decorator:&Decorator<'a>) { walk_decorator(self, decorator); }

	fn visit_class(&mut self, class:&Class<'a>) { walk_class(self, class); }

	fn visit_class_heritage(&mut self, expr:&Expression<'a>) { walk_class_heritage(self, expr); }

	fn visit_ts_class_implements(&mut self, expr:&TSClassImplements<'a>) {
		walk_ts_class_implements(self, expr);
	}

	fn visit_class_body(&mut self, body:&ClassBody<'a>) { walk_class_body(self, body); }

	fn visit_class_element(&mut self, elem:&ClassElement<'a>) { walk_class_element(self, elem); }

	fn visit_static_block(&mut self, block:&StaticBlock<'a>) { walk_static_block(self, block); }
	...
	fn visit_expression(&mut self, expr:&Expression<'a>) { walk_expression(self, expr); }

	fn visit_meta_property(&mut self, meta:&MetaProperty<'a>) { walk_meta_property(self, meta); }
	...
	fn visit_argument(&mut self, arg:&Argument<'a>) { walk_argument(self, arg); }

	fn visit_spread_element(&mut self, elem:&SpreadElement<'a>) { walk_spread_element(self, elem); }

	fn visit_expression_array_element(&mut self, expr:&Expression<'a>) {
		walk_expression_array_element(self, expr);
	}

	fn visit_elision(&mut self, elision:&Elision) { walk_elision(self, elision); }
	...
	fn visit_chain_element(&mut self, elem:&ChainElement<'a>) { walk_chain_element(self, elem); }
	...
	fn visit_new_expression(&mut self, expr:&NewExpression<'a>) { walk_new_expression(self, expr); }
	...
	fn visit_property_key(&mut self, key:&PropertyKey<'a>) { walk_property_key(self, key); }
	...
	fn visit_this_expression(&mut self, expr:&ThisExpression) { walk_this_expression(self, expr); }
	...
	fn visit_super(&mut self, expr:&Super) { walk_super(self, expr); }
	...
	fn visit_jsx_element(&mut self, elem:&JSXElement<'a>) { walk_jsx_element(self, elem); }
	...
	fn visit_jsx_expression(&mut self, expr:&JSXExpression<'a>) { walk_jsx_expression(self, expr); }

	fn visit_jsx_fragment(&mut self, elem:&JSXFragment<'a>) { walk_jsx_fragment(self, elem); }

	fn visit_jsx_child(&mut self, child:&JSXChild<'a>) { walk_jsx_child(self, child); }

	fn visit_jsx_spread_child(&mut self, child:&JSXSpreadChild<'a>) {
		walk_jsx_spread_child(self, child);
	}

	fn visit_jsx_text(&mut self, child:&JSXText<'a>) { walk_jsx_text(self, child); }
	...
	fn visit_object_pattern(&mut self, pat:&ObjectPattern<'a>) { walk_object_pattern(self, pat); }

	fn visit_binding_property(&mut self, prop:&BindingProperty<'a>) {
		walk_binding_property(self, prop);
	}

	fn visit_array_pattern(&mut self, pat:&ArrayPattern<'a>) { walk_array_pattern(self, pat); }

	fn visit_rest_element(&mut self, pat:&BindingRestElement<'a>) { walk_rest_element(self, pat); }
	...
	fn visit_number_literal(&mut self, lit:&NumericLiteral<'a>) { walk_number_literal(self, lit); }

	fn visit_boolean_literal(&mut self, lit:&BooleanLiteral) { walk_boolean_literal(self, lit); }

	fn visit_null_literal(&mut self, lit:&NullLiteral) { walk_null_literal(self, lit); }

	fn visit_bigint_literal(&mut self, lit:&BigIntLiteral<'a>) { walk_bigint_literal(self, lit); }

	fn visit_string_literal(&mut self, lit:&StringLiteral<'a>) { walk_string_literal(self, lit); }
	...
	fn visit_enum_member(&mut self, member:&TSEnumMember<'a>) { walk_enum_member(self, member); }

	fn visit_enum(&mut self, decl:&TSEnumDeclaration<'a>) { walk_enum(self, decl); }

	fn visit_declaration(&mut self, decl:&Declaration<'a>) { walk_declaration(self, decl); }
	...
	fn visit_ts_type_name(&mut self, name:&TSTypeName<'a>) { walk_ts_type_name(self, name); }
	...
	fn visit_ts_type(&mut self, ty:&TSType<'a>) { walk_ts_type(self, ty); }
	...
	fn visit_ts_any_keyword(&mut self, ty:&TSAnyKeyword) { walk_ts_any_keyword(self, ty); }
	...
	fn visit_ts_never_keyword(&mut self, ty:&TSNeverKeyword) { walk_ts_never_keyword(self, ty); }

	fn visit_ts_null_keyword(&mut self, ty:&TSNullKeyword) { walk_ts_null_keyword(self, ty); }

	fn visit_ts_number_keyword(&mut self, ty:&TSNumberKeyword) { walk_ts_number_keyword(self, ty); }

	fn visit_ts_object_keyword(&mut self, ty:&TSObjectKeyword) { walk_ts_object_keyword(self, ty); }

	fn visit_ts_string_keyword(&mut self, ty:&TSStringKeyword) { walk_ts_string_keyword(self, ty); }

	fn visit_ts_symbol_keyword(&mut self, ty:&TSSymbolKeyword) { walk_ts_symbol_keyword(self, ty); }
	...
	fn visit_ts_void_keyword(&mut self, ty:&TSVoidKeyword) { walk_ts_void_keyword(self, ty); }

	fn visit_ts_array_type(&mut self, ty:&TSArrayType<'a>) { walk_ts_array_type(self, ty); }
	...
	fn visit_ts_import_type(&mut self, ty:&TSImportType<'a>) { walk_ts_import_type(self, ty); }

	fn visit_ts_indexed_access_type(&mut self, ty:&TSIndexedAccessType<'a>) {
		walk_ts_indexed_access_type(self, ty);
	}

	fn visit_ts_infer_type(&mut self, ty:&TSInferType<'a>) { walk_ts_infer_type(self, ty); }

	fn visit_ts_intersection_type(&mut self, ty:&TSIntersectionType<'a>) {
		walk_ts_intersection_type(self, ty);
	}

	fn visit_ts_literal_type(&mut self, ty:&TSLiteralType<'a>) { walk_ts_literal_type(self, ty); }

	fn visit_ts_mapped_type(&mut self, ty:&TSMappedType<'a>) { walk_ts_mapped_type(self, ty); }
	...
	fn visit_ts_this_type(&mut self, ty:&TSThisType) { walk_ts_this_type(self, ty); }

	fn visit_ts_tuple_type(&mut self, ty:&TSTupleType<'a>) { walk_ts_tuple_type(self, ty); }

	fn visit_ts_type_literal(&mut self, ty:&TSTypeLiteral<'a>) { walk_ts_type_literal(self, ty); }
	...
	fn visit_ts_type_query(&mut self, ty:&TSTypeQuery<'a>) { walk_ts_type_query(self, ty); }

	fn visit_ts_type_reference(&mut self, ty:&TSTypeReference<'a>) {
		walk_ts_type_reference(self, ty);
	}

	fn visit_ts_union_type(&mut self, ty:&TSUnionType<'a>) { walk_ts_union_type(self, ty); }
...
pub mod walk {
	...
	pub fn walk_continue_statement<'a, V:Visit<'a>>(visitor:&mut V, stmt:&ContinueStatement<'a>) {
	...
	pub fn walk_formal_parameters<'a, V:Visit<'a>>(visitor:&mut V, params:&FormalParameters<'a>) {
	...
	pub fn walk_class<'a, V:Visit<'a>>(visitor:&mut V, class:&Class<'a>) {
		// Class level decorators are transpiled as functions outside of the
		// class taking the class itvisitor as argument. They should be
		// visited before class is entered. E.g., they inherit strict mode
		// from the enclosing scope rather than from class.
		...
		if is_class_expr {
			// Class expressions create a temporary scope with the class name as
			// its only variable E.g., `let c = class A { foo() {
			// console.log(A) } }`
			visitor.enter_scope(ScopeFlags::empty());
		}
	...
	pub fn walk_property_definition<'a, V:Visit<'a>>(visitor:&mut V, def:&PropertyDefinition<'a>) {
	...
	pub fn walk_logical_expression<'a, V:Visit<'a>>(visitor:&mut V, expr:&LogicalExpression<'a>) {
	...
	pub fn walk_sequence_expression<'a, V:Visit<'a>>(visitor:&mut V, expr:&SequenceExpression<'a>) {
	...
	pub fn walk_assignment_target<'a, V:Visit<'a>>(visitor:&mut V, target:&AssignmentTarget<'a>) {
	...
	pub fn walk_jsx_opening_element<'a, V:Visit<'a>>(visitor:&mut V, elem:&JSXOpeningElement<'a>) {
	...
	pub fn walk_jsx_closing_element<'a, V:Visit<'a>>(visitor:&mut V, elem:&JSXClosingElement<'a>) {
	...
	pub fn walk_jsx_namespaced_name<'a, V:Visit<'a>>(visitor:&mut V, name:&JSXNamespacedName<'a>) {
	...
	pub fn walk_jsx_attribute_value<'a, V:Visit<'a>>(visitor:&mut V, value:&JSXAttributeValue<'a>) {
		match value {
	...
	pub fn walk_binding_identifier<'a, V:Visit<'a>>(visitor:&mut V, ident:&BindingIdentifier<'a>) {
	...
	pub fn walk_private_identifier<'a, V:Visit<'a>>(visitor:&mut V, ident:&PrivateIdentifier<'a>) {
	...
	pub fn walk_module_declaration<'a, V:Visit<'a>>(visitor:&mut V, decl:&ModuleDeclaration<'a>) {
	...
	pub fn walk_import_declaration<'a, V:Visit<'a>>(visitor:&mut V, decl:&ImportDeclaration<'a>) {
	...
	pub fn walk_import_attribute<'a, V:Visit<'a>>(visitor:&mut V, attribute:&ImportAttribute<'a>) {
		visitor.visit_import_attribute_key(&attribute.key);

		visitor.visit_string_literal(&attribute.value);
	}

	pub fn walk_import_attribute_key<'a, V:Visit<'a>>(visitor:&mut V, key:&ImportAttributeKey<'a>) {
		match key {
	...
	pub fn walk_import_specifier<'a, V:Visit<'a>>(visitor:&mut V, specifier:&ImportSpecifier<'a>) {
	...
	pub fn walk_export_specifier<'a, V:Visit<'a>>(visitor:&mut V, specifier:&ExportSpecifier<'a>) {
	...
	pub fn walk_ts_intersection_type<'a, V:Visit<'a>>(visitor:&mut V, ty:&TSIntersectionType<'a>) {
	...
	pub fn walk_ts_named_tuple_member<'a, V:Visit<'a>>(visitor:&mut V, ty:&TSNamedTupleMember<'a>) {
