...
pub trait VisitMut<'a>: Sized {
	...
	fn visit_program(&mut self, program:&mut Program<'a>) { walk_program_mut(self, program); }
	...
	fn visit_statement(&mut self, stmt:&mut Statement<'a>) { walk_statement_mut(self, stmt); }
	...
	fn visit_switch_case(&mut self, case:&mut SwitchCase<'a>) { walk_switch_case_mut(self, case); }
	...
	fn visit_class(&mut self, class:&mut Class<'a>) { walk_class_mut(self, class); }

	fn visit_class_heritage(&mut self, expr:&mut Expression<'a>) {
		walk_class_heritage_mut(self, expr);
	}

	fn visit_class_body(&mut self, body:&mut ClassBody<'a>) { walk_class_body_mut(self, body); }
	...
	fn visit_expression(&mut self, expr:&mut Expression<'a>) { walk_expression_mut(self, expr); }
	...
	fn visit_argument(&mut self, arg:&mut Argument<'a>) { walk_argument_mut(self, arg); }
	...
	fn visit_elision(&mut self, elision:&mut Elision) { walk_elision_mut(self, elision); }
	...
	fn visit_property_key(&mut self, key:&mut PropertyKey<'a>) { walk_property_key_mut(self, key); }
	...
	fn visit_super(&mut self, expr:&mut Super) { walk_super_mut(self, expr); }
	...
	fn visit_jsx_element(&mut self, elem:&mut JSXElement<'a>) { walk_jsx_element_mut(self, elem); }
	...
	fn visit_jsx_child(&mut self, child:&mut JSXChild<'a>) { walk_jsx_child_mut(self, child); }

	fn visit_jsx_spread_child(&mut self, child:&mut JSXSpreadChild<'a>) {
		walk_jsx_spread_child_mut(self, child);
	}

	fn visit_jsx_text(&mut self, child:&JSXText<'a>) { walk_jsx_text_mut(self, child); }
	...
	fn visit_null_literal(&mut self, lit:&mut NullLiteral) { walk_null_literal_mut(self, lit); }
	...
	fn visit_enum(&mut self, decl:&mut TSEnumDeclaration<'a>) { walk_enum_mut(self, decl); }

	fn visit_declaration(&mut self, decl:&mut Declaration<'a>) { walk_declaration_mut(self, decl); }
	...
	fn visit_ts_external_module_reference(&mut self, reference:&mut TSExternalModuleReference<'a>) {
	...
	fn visit_ts_type(&mut self, ty:&mut TSType<'a>) { walk_ts_type_mut(self, ty); }
	...
	fn visit_ts_tuple_type(&mut self, ty:&mut TSTupleType<'a>) { walk_ts_tuple_type_mut(self, ty); }
	...
	fn visit_ts_array_type(&mut self, ty:&mut TSArrayType<'a>) { walk_ts_array_type_mut(self, ty); }

	fn visit_ts_null_keyword(&mut self, ty:&mut TSNullKeyword) {
		walk_ts_null_keyword_mut(self, ty);
	}

	fn visit_ts_any_keyword(&mut self, ty:&mut TSAnyKeyword) { walk_ts_any_keyword_mut(self, ty); }
	...
	fn visit_ts_union_type(&mut self, ty:&mut TSUnionType<'a>) { walk_ts_union_type_mut(self, ty); }
	...
	fn visit_ts_type_query(&mut self, ty:&mut TSTypeQuery<'a>) { walk_ts_type_query_mut(self, ty); }
...
pub mod walk_mut {
	...
	pub fn walk_empty_statement_mut<'a, V:VisitMut<'a>>(visitor:&mut V, _stmt:&mut EmptyStatement) {
	...
	pub fn walk_for_statement_mut<'a, V:VisitMut<'a>>(visitor:&mut V, stmt:&mut ForStatement<'a>) {
	...
	pub fn walk_try_statement_mut<'a, V:VisitMut<'a>>(visitor:&mut V, stmt:&mut TryStatement<'a>) {
	...
	pub fn walk_catch_clause_mut<'a, V:VisitMut<'a>>(visitor:&mut V, clause:&mut CatchClause<'a>) {
	...
	pub fn walk_function_body_mut<'a, V:VisitMut<'a>>(visitor:&mut V, body:&mut FunctionBody<'a>) {
	...
	pub fn walk_class_heritage_mut<'a, V:VisitMut<'a>>(visitor:&mut V, expr:&mut Expression<'a>) {
	...
	pub fn walk_class_element_mut<'a, V:VisitMut<'a>>(visitor:&mut V, elem:&mut ClassElement<'a>) {
		match elem {
	...
	pub fn walk_static_block_mut<'a, V:VisitMut<'a>>(visitor:&mut V, block:&mut StaticBlock<'a>) {
	...
	pub fn walk_meta_property_mut<'a, V:VisitMut<'a>>(visitor:&mut V, _meta:&mut MetaProperty<'a>) {
	...
	pub fn walk_chain_element_mut<'a, V:VisitMut<'a>>(visitor:&mut V, elem:&mut ChainElement<'a>) {
		match elem {
	...
	pub fn walk_this_expression_mut<'a, V:VisitMut<'a>>(visitor:&mut V, _expr:&mut ThisExpression) {
	...
	pub fn walk_object_pattern_mut<'a, V:VisitMut<'a>>(visitor:&mut V, pat:&mut ObjectPattern<'a>) {
	...
	pub fn walk_array_pattern_mut<'a, V:VisitMut<'a>>(visitor:&mut V, pat:&mut ArrayPattern<'a>) {
	...
	pub fn walk_boolean_literal_mut<'a, V:VisitMut<'a>>(visitor:&mut V, _lit:&mut BooleanLiteral) {
	...
	pub fn walk_enum_member_mut<'a, V:VisitMut<'a>>(visitor:&mut V, member:&mut TSEnumMember<'a>) {
	...
	pub fn walk_ts_type_literal_mut<'a, V:VisitMut<'a>>(visitor:&mut V, ty:&mut TSTypeLiteral<'a>) {
	...
	pub fn walk_ts_mapped_type_mut<'a, V:VisitMut<'a>>(visitor:&mut V, ty:&mut TSMappedType<'a>) {
	...
	pub fn walk_ts_literal_type_mut<'a, V:VisitMut<'a>>(visitor:&mut V, ty:&mut TSLiteralType<'a>) {
	...
	pub fn walk_ts_import_type_mut<'a, V:VisitMut<'a>>(visitor:&mut V, ty:&mut TSImportType<'a>) {
