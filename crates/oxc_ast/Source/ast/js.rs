...
pub struct TemplateElementValue<'a> {
	...
	/// This interpretation of the template strings is stored as an Array in
	/// the first argument. cooked = None when template literal has invalid
	/// escape sequence
...
pub struct Directive<'a> {
	...
	/// Raw content of directive as it appears in source, any escapes left as
	/// is
...
pub struct ExportAllDeclaration<'a> {
	...
	pub with_clause:Option<Box<'a, WithClause<'a>>>, /* Some(vec![]) for
	                                                  * empty assertion */
