...
impl<'a> GatherNodeParts<'a> for ImportDeclaration<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.source.gather(f); }
}
...
impl<'a> GatherNodeParts<'a> for ExportDefaultDeclaration<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.declaration.gather(f); }
}
...
impl<'a> GatherNodeParts<'a> for ImportSpecifier<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.local.gather(f); }
}
...
impl<'a> GatherNodeParts<'a> for BindingRestElement<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.argument.gather(f); }
}

// -------------------- BindingPattern --------------------

impl<'a> GatherNodeParts<'a> for VariableDeclarator<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.id.gather(f); }
}

impl<'a> GatherNodeParts<'a> for BindingPattern<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.bound_names(&mut |id| f(id.name.as_str())); }
}
...
impl<'a> GatherNodeParts<'a> for ChainExpression<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.expression.gather(f); }
}
...
impl<'a> GatherNodeParts<'a> for CallExpression<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.callee.gather(f); }
}
...
impl GatherNodeParts<'_> for ThisExpression {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f("this"); }
}

impl GatherNodeParts<'_> for Super {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f("super"); }
}

impl<'a> GatherNodeParts<'a> for ImportExpression<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f("import"); }
}
...
impl<'a> GatherNodeParts<'a> for AssignmentExpression<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.left.gather(f); }
}
...
impl<'a> GatherNodeParts<'a> for PropertyDefinition<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.key.gather(f); }
}
...
impl<'a> GatherNodeParts<'a> for BindingIdentifier<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f(self.name.as_str()); }
}
...
impl<'a> GatherNodeParts<'a> for StringLiteral<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f(self.value.as_str()); }
}

impl<'a> GatherNodeParts<'a> for NumericLiteral<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f(&self.raw_str()); }
}
...
impl<'a> GatherNodeParts<'a> for BigIntLiteral<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f(self.raw.as_str()); }
}

// -------------------- JSX --------------------

impl<'a> GatherNodeParts<'a> for JSXElement<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.opening_element.gather(f); }
}

impl<'a> GatherNodeParts<'a> for JSXFragment<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.opening_fragment.gather(f); }
}

impl<'a> GatherNodeParts<'a> for JSXOpeningElement<'a> {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { self.name.gather(f); }
}

impl GatherNodeParts<'_> for JSXOpeningFragment {
	fn gather<F:FnMut(&str)>(&self, f:&mut F) { f("Fragment"); }
}
