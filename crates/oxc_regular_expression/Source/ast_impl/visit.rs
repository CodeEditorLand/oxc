...
// But like `oxc_ast`, this should be generated by `tasks/ast_tools` in the
// future.
...
pub trait Visit<'a>: Sized {
	...
	#[inline]
	fn visit_pattern(&mut self, it:&Pattern<'a>) { walk_pattern(self, it); }

	#[inline]
	fn visit_disjunction(&mut self, it:&Disjunction<'a>) { walk_disjunction(self, it); }

	#[inline]
	fn visit_alternative(&mut self, it:&Alternative<'a>) { walk_alternative(self, it); }

	#[inline]
	fn visit_term(&mut self, it:&Term<'a>) { walk_term(self, it); }
	...
	#[inline]
	fn visit_quantifier(&mut self, it:&Quantifier<'a>) { walk_quantifier(self, it); }

	#[inline]
	fn visit_capturing_group(&mut self, it:&CapturingGroup<'a>) { walk_capturing_group(self, it); }

	#[inline]
	fn visit_ignore_group(&mut self, it:&IgnoreGroup<'a>) { walk_ignore_group(self, it); }
	...
	#[inline]
	fn visit_character(&mut self, it:&Character) { walk_character(self, it); }

	#[inline]
	fn visit_dot(&mut self, it:&Dot) { walk_dot(self, it); }
	...
	#[inline]
	fn visit_character_class(&mut self, it:&CharacterClass<'a>) { walk_character_class(self, it); }
	...
	#[inline]
	fn visit_named_reference(&mut self, it:&NamedReference<'a>) { walk_named_reference(self, it); }
}
...
pub mod walk {
	...
	#[inline]
	pub fn walk_lookaround_assertion<'a, V:Visit<'a>>(visitor:&mut V, it:&LookAroundAssertion<'a>) {
	...
	#[inline]
	pub fn walk_character_class_escape<'a, V:Visit<'a>>(visitor:&mut V, it:&CharacterClassEscape) {
