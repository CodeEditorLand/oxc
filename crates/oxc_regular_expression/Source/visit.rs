...
use crate::ast::{
	...
	CharacterClassContents, CharacterClassEscape, CharacterClassRange,
	ClassString, ClassStringDisjunction, Disjunction, Dot, IgnoreGroup,
	IndexedReference, LookAroundAssertion, NamedReference, Pattern, Quantifier,
	Term, UnicodePropertyEscape,
};
use walk::*;
...
pub trait Visit<'a>: Sized {
	...
	#[inline]
	fn visit_unicode_property_escape(
		&mut self,
	...
	#[inline]
	fn visit_character_class_contents(
		&mut self,
	...
	#[inline]
	fn visit_character_class_string_disjunction(
		&mut self,
...
pub mod walk {
	...
	#[inline]
	pub fn walk_disjunction<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &Disjunction<'a>,
	) {
	...
	#[inline]
	pub fn walk_alternative<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &Alternative<'a>,
	) {
	...
	#[inline]
	pub fn walk_quantifier<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &Quantifier<'a>,
	) {
	...
	#[inline]
	pub fn walk_capturing_group<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &CapturingGroup<'a>,
	) {
	...
	#[inline]
	pub fn walk_ignore_group<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &IgnoreGroup<'a>,
	) {
	...
	#[inline]
	pub fn walk_boundary_assertion<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &BoundaryAssertion,
	) {
	...
	#[inline]
	pub fn walk_character_class<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &CharacterClass<'a>,
	) {
	...
	pub fn walk_character_class_contents<'a, V: Visit<'a>>(
		...
		match it {
			...
			CharacterClassContents::ClassStringDisjunction(
				...
				visitor.visit_character_class_string_disjunction(
					class_string_disjunction,
				);
			},
		}
	...
	#[inline]
	pub fn walk_character_class_range<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &CharacterClassRange,
	) {
	...
	pub fn walk_character_class_string_disjunction<'a, V: Visit<'a>>(
		...
		let kind =
			RegExpAstKind::CharacterClassStringDisjunction(visitor.alloc(it));
		visitor.enter_node(kind);
	...
	#[inline]
	pub fn walk_character_class_string<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &ClassString<'a>,
	) {
	...
	#[inline]
	pub fn walk_indexed_reference<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &IndexedReference,
	) {
	...
	#[inline]
	pub fn walk_named_reference<'a, V: Visit<'a>>(
		visitor: &mut V,
		it: &NamedReference<'a>,
	) {
