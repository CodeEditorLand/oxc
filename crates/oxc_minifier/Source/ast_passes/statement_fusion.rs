...
mod test {
	...
	fn fuse_into_for_in2() {
		// This test case causes a parse warning in ES5 strict out, but is a
		// parse error in ES6+ out. setAcceptedLanguage(CompilerOptions.
	...
	fn no_fuse_into_block() {
		...
		// declarations, or you risk colliding variable names. (unless the AST
		// is normalized).
		fuse("a; {b;}", "{a,b;}");
