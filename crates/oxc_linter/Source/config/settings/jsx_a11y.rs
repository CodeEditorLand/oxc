...
pub struct JSXA11yPluginSettings {
	/// An optional setting that define the prop your code uses to create
	/// polymorphic components. This setting will be used to determine the
	/// element type in rules that require semantic context.
	///
	/// For example, if you set the `polymorphicPropName` to `as`, then this
	/// element:
	///
	/// ```jsx
	/// <Box as="h3">Hello</Box>
