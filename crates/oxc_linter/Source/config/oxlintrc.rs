...
///
/// This configuration is aligned with ESLint v8's configuration schema
/// (`eslintrc.json`).
///
...
/// ::: danger NOTE
///
/// Only the `.json` format is supported. You can use comments in configuration
/// files.
///
/// :::
///
...
pub struct Oxlintrc {
	...
	/// Add, remove, or otherwise reconfigure rules for specific files or groups
	/// of files.
	...
	#[serde(skip)]
	pub path:PathBuf,
	/// Globs to ignore during linting. These are resolved from the
