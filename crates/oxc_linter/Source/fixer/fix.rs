...
impl<'a> CompositeFix<'a> {
	...
	// Self::Multiple(vec![fix1.clone(), fix2]),
	// Self::Multiple(mut fixes) => {                     fixes.insert(0,
	...
	/// those into one. <https://github.com/eslint/eslint/blob/main/lib/linter/report-translator.js#L181-L203>
