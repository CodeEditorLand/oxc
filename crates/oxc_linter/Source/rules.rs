...
//!
//! New rules need be added to these `mod` statements and also the macro at the
//! bottom.
//!
//! These modules are declared manually because `cargo fmt` stops formatting
//! these files with they are inside a proc macro.
