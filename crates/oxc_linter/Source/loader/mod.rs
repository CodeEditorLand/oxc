...
// TODO: use oxc_resolver::FileSystem. We can't do so until that crate exposes
// FileSystemOs externally.
...
impl fmt::Display for LoadError {
	fn fmt(&self, f:&mut fmt::Formatter<'_>) -> fmt::Result {
		match self {
			Self::TooLarge => {
				write!(f, "file is too large. Only files up to 4GB are supported.")
			},
