...
pub(crate) struct ContextHost<'a> {
	...
	/// Information about specific rules that should be disabled or enabled,
	/// via comment directives like `eslint-disable` or
...
impl<'a> ContextHost<'a> {
	...
	pub fn new<P:AsRef<Path>>(file_path:P, semantic:Rc<Semantic<'a>>, options:LintOptions) -> Self {
