...
/// Many Vitest rule are essentially ports of Jest plugin rules with minor
/// modifications. For these rules, we use the corresponding jest rules with
/// some adjustments for compatibility.
...
/// Many Typescript rule are essentially ports of Eslint plugin rules with minor
/// modifications. For these rules, we use the corresponding eslint rules with
/// some adjustments for compatibility.
