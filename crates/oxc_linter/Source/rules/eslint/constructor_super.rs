...
// #[diagnostic(severity(warning), help("Ensure 'super()' is called from
// constructor"))] struct ConstructorSuperDiagnostic(#[label] pub Span);

// #[derive(Debug, Error, Diagnostic)]
// #[error("Unexpected 'super()' because 'super' is not a constructor.")]
// #[diagnostic(severity(warning), help("Do not call 'super()' from
// constructor."))] struct SuperNotConstructorDiagnostic(
