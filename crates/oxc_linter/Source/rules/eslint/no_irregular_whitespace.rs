...
fn test() {
	...
	let pass = vec![
		...
		(r"// ᠎", Some(serde_json::json!([{ "skipComments": true }]))),
		(r"// ﻿", Some(serde_json::json!([{ "skipComments": true }]))),
		// (r"//  ", Some(serde_json::json!([{ "skipComments": true }]))), lint
		// error (r"//  ", Some(serde_json::json!([{ "skipComments": true
		// }]))), lint error
		(r"//  ", Some(serde_json::json!([{ "skipComments": true }]))),
		(r"//  ", Some(serde_json::json!([{ "skipComments": true }]))),
		(r"//  ", Some(serde_json::json!([{ "skipComments": true }]))),
		...
		(r"/* ﻿ */", Some(serde_json::json!([{ "skipComments": true }]))),
		// (r"/*   */", Some(serde_json::json!([{ "skipComments": true }]))),
		// lint error (r"/*   */", Some(serde_json::json!([{ "skipComments":
		// true }]))), lint error
		(r"/*   */", Some(serde_json::json!([{ "skipComments": true }]))),
		(r"/*   */", Some(serde_json::json!([{ "skipComments": true }]))),
		(r"/*   */", Some(serde_json::json!([{ "skipComments": true }]))),
		...
		(r"/᠎/", Some(serde_json::json!([{ "skipRegExps": true }]))),
		(r"/﻿/", Some(serde_json::json!([{ "skipRegExps": true }]))),
		// (r"/ /", Some(serde_json::json!([{ "skipRegExps": true }]))), lint
		// error (r"/ /", Some(serde_json::json!([{ "skipRegExps": true
		// }]))), lint error
		(r"/ /", Some(serde_json::json!([{ "skipRegExps": true }]))),
		(r"/ /", Some(serde_json::json!([{ "skipRegExps": true }]))),
		(r"/ /", Some(serde_json::json!([{ "skipRegExps": true }]))),
		...
		(r"`﻿`", Some(serde_json::json!([{ "skipTemplates": true }]))),
		// (r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		// lint error (r"` `", Some(serde_json::json!([{ "skipTemplates":
		// true }]))),  lint error
		(r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		(r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		(r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		...
		(r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		(r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		// (r"`​`", Some(serde_json::json!([{ "skipTemplates": true }]))),  lint
		// error
		(r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		(r"` `", Some(serde_json::json!([{ "skipTemplates": true }]))),
		(r"`　`", Some(serde_json::json!([{ "skipTemplates": true }]))),
		...
		(r"<div>﻿</div>;", Some(serde_json::json!([{ "skipJSXText": true }]))),
		// (r"<div> </div>;", Some(serde_json::json!([{ "skipJSXText": true
		// }]))),  lint error (r"<div> </div>;", Some(serde_json::json!([{
		// "skipJSXText": true }]))),  lint error
		(r"<div> </div>;", Some(serde_json::json!([{ "skipJSXText": true }]))),
		(r"<div> </div>;", Some(serde_json::json!([{ "skipJSXText": true }]))),
		(r"<div> </div>;", Some(serde_json::json!([{ "skipJSXText": true }]))),
		(r"<div> </div>;", Some(serde_json::json!([{ "skipJSXText": true }]))),
	...
	let fail = vec![
		...
		// (r"var any = '　', other = '';", Some(serde_json::json!([{
		// "skipStrings": false }]))), (r"var any = `　`, other = ``;",
		// Some(serde_json::json!([{ "skipTemplates": false }]))),
		(
