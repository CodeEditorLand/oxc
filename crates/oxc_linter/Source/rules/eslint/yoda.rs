...
fn test() {
	...
	let pass = vec![
		...
		("if (value === `red`) {}", Some(serde_json::json!(["never"]))), /* { "ecmaVersion":
		                                                                  * 2015 }, */
		("if (`red` === `red`) {}", Some(serde_json::json!(["never"]))), /* { "ecmaVersion":
		                                                                  * 2015 }, */
		("if (`${foo}` === `red`) {}", Some(serde_json::json!(["never"]))), /* { "ecmaVersion":
		                                                                     * 2015 }, */
		(r#"if (`${""}` === `red`) {}"#, Some(serde_json::json!(["never"]))), /* { "ecmaVersion"
		                                                                       * : 2015 }, */
		(r#"if (`${"red"}` === foo) {}"#, Some(serde_json::json!(["never"]))), /* { "ecmaVersion": 2015 }, */
		("if (b > `a` && b > `a`) {}", Some(serde_json::json!(["never"]))),    /* { "ecmaVersion":
		                                                                        * 2015 }, */
		...
		("if (`red` === value) {}", Some(serde_json::json!(["always"]))), /* { "ecmaVersion":
		                                                                   * 2015 }, */
		("if (`red` === `red`) {}", Some(serde_json::json!(["always"]))), /* { "ecmaVersion":
		                                                                   * 2015 }, */
		("if (`red` === `${foo}`) {}", Some(serde_json::json!(["always"]))), /* { "ecmaVersion":
		                                                                      * 2015 }, */
		(r#"if (`red` === `${""}`) {}"#, Some(serde_json::json!(["always"]))), /* { "ecmaVersion": 2015 }, */
		(r#"if (foo === `${"red"}`) {}"#, Some(serde_json::json!(["always"]))), /* { "ecmaVersion": 2015 }, */
		("if (`a` > b && `a` > b) {}", Some(serde_json::json!(["always"]))),    /* { "ecmaVersion":
		                                                                         * 2015 }, */
		...
		("if ('a' < x && x < MAX ) {}", Some(serde_json::json!(["always"]))), /* { "ecmaVersion"
		                                                                       * : 2015 }, */
		(
			"if (MIN < x && x < 'a' ) {}",
			Some(serde_json::json!(["never", { "exceptRange": true }])),
		), // { "ecmaVersion": 2015 },
		("if (MIN < x && x < 'a' ) {}", Some(serde_json::json!(["never"]))), /* { "ecmaVersion":
		                                                                      * 2015 }, */
		(
			"if (`blue` < x.y && x.y < `green`) {}",
			Some(serde_json::json!(["never", { "exceptRange": true }])),
	...
	let fail = vec![
		...
		("if (value == `red`) {}", Some(serde_json::json!(["always"]))), /* { "ecmaVersion":
		                                                                  * 2015 }, */
	...
	Tester::new(Yoda::NAME, Yoda::CATEGORY, pass, fail)
		.expect_fix(fix)
		.test_and_snapshot();
}
