...
impl NoUnusedVars {
	...
	///
	/// - Variable declarations will only be deleted if they have 0 references
	///   of any kind.
	...
	pub(in super::super) fn rename_or_remove_var_declaration<'a>(
		...
		let (span, declarations) = match parent {
			...
			_ => {
				#[cfg(debug_assertions)]
				panic!(
					"VariableDeclarator nodes should always be direct children of \
