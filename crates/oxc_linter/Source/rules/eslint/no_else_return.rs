...
fn test() {
	...
	let fix = vec![
		...
		(
			...
			"function foo5() { if (true) { if (false) { if (true) return x; w = y; } else { w = \
			 x; } } else { return z; } }",
			None,
		),
		(
			...
			"function foo6() { if (true) { if (false) { if (true) return x; return y; } } else { \
			 return z; } }",
			None,
		),
		(
			"function foo7() { if (true) { if (false) { if (true) return x; else return y; } \
			 return w; } else { return z; } }",
			"function foo7() { if (true) { if (false) { if (true) return x; return y; } return w; \
			 } return z; }",
			None,
		),
		(
			"function foo8() { if (true) { if (false) { if (true) return x; else return y; } else \
			 { w = x; } } else { return z; } }",
			"function foo8() { if (true) { if (false) { if (true) return x; return y; } w = x; } \
			 else { return z; } }",
			None,
		),
		(
		...
		(
			"function foo9a() {if (x) { return true; } else if (y) { return true; } else { \
			 notAReturn(); } }",
			"function foo9a() {if (x) { return true; } if (y) { return true; } else { \
			 notAReturn(); } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
		...
		(
			"function foo20() {if (x) { return true; } else if (y) { notAReturn() } else { \
			 notAReturn(); } }",
			"function foo20() {if (x) { return true; } if (y) { notAReturn() } else { \
			 notAReturn(); } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
			"function foo21() { var x = true; if (x) { return x; } else if (x === false) { return \
			 false; } }",
			"function foo21() { var x = true; if (x) { return x; } if (x === false) { return \
			 false; } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
		...
		(
			"function foo() { if (bar) { if (baz) { return true; } else { let a; } } if (quux) { \
			 function a(){}  } }",
			"function foo() { if (bar) { if (baz) { return true; } let a; } if (quux) { function \
			 a(){}  } }",
			None,
		),
		(
