...
impl Rule for NoElseReturn {
	fn from_configuration(value:serde_json::Value) -> Self {
		let Some(value) = value.get(0) else {
			return Self { allow_else_if:true };
		};
		Self {
			allow_else_if:value
				.get("allowElseIf")
...
fn test() {
	...
	let pass = vec![
		...
		(
			"function foo() { var x = true; if (x) { return x; } else if (x === false) { return \
			 false; } }",
			None,
		),
		("function foo() { if (true) notAReturn(); else return y; }", None),
		(
			"function foo() {if (x) { notAReturn(); } else if (y) { return true; } else { \
			 notAReturn(); } }",
			None,
		),
		(
			"function foo() {if (x) { return true; } else if (y) { notAReturn() } else { \
			 notAReturn(); } }",
			None,
		),
		...
		(
			"function foo20() {if (x) { return true; } else if (y) { notAReturn() } else { \
			 notAReturn(); } }",
			Some(serde_json::json!([{ "allowElseIf": true }])),
		),
		(
			"function foo21() { var x = true; if (x) { return x; } else if (x === false) { return \
			 false; } }",
			Some(serde_json::json!([{ "allowElseIf": true }])),
		),
	];
	...
	let fail = vec![
		...
		(
			"function foo5() { if (true) { if (false) { if (true) return x; else { w = y; } } \
			 else { w = x; } } else { return z; } }",
			None,
		),
		(
			"function foo6() { if (true) { if (false) { if (true) return x; else return y; } } \
			 else { return z; } }",
			None,
		),
		(
			"function foo7() { if (true) { if (false) { if (true) return x; else return y; } \
			 return w; } else { return z; } }",
			None,
		),
		(
			"function foo8() { if (true) { if (false) { if (true) return x; else return y; } else \
			 { w = x; } } else { return z; } }",
			None,
		),
		(
			"function foo9() {if (x) { return true; } else if (y) { return true; } else { \
			 notAReturn(); } }",
			None,
		),
		(
			"function foo9a() {if (x) { return true; } else if (y) { return true; } else { \
			 notAReturn(); } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
			"function foo9b() {if (x) { return true; } if (y) { return true; } else { \
			 notAReturn(); } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		...
		(
			"function foo() { if (bar) { class a {}; if (baz) { return true; } else { const a = \
			 1; } } }",
			None,
		), /* { "ecmaVersion": 6 }, */
		(
		...
		(
			"function foo(a, b = a) { if (bar) { return true; } else { let a; }  if (bar) { \
			 return true; } else { let b; }}",
			None,
		), /* { "ecmaVersion": 6 }, */
		...
		(
			"function foo() { try {} catch (a) { if (bar) { if (baz) { return true; } else { let \
			 a; } } } }",
			None,
		), /* { "ecmaVersion": 6 }, */
		(
			"function foo() { try {} catch ({bar, a = 1}) { if (baz) { return true; } else { let \
			 a; } } }",
			None,
		), /* { "ecmaVersion": 6 }, */
		("function foo() { if (bar) { return true; } else { let arguments; } }", None), /* { "ecmaVersion": 6 }, */
		(
			"function foo() { if (bar) { return true; } else { let arguments; } return \
			 arguments[0]; }",
			None,
		), /* { "ecmaVersion": 6 }, */
		(
			"function foo() { if (bar) { return true; } else { let arguments; } if (baz) { return \
			 arguments[0]; } }",
			None,
		), /* { "ecmaVersion": 6 }, */
		(
		...
		("function a() { if (a) { return true; } else { let a; } }", None), /* { "ecmaVersion":
		                                                                     * 6 }, */
		...
		(
			"function foo() { if (bar) { if (baz) { return true; } else { let a; } if (quux) { \
			 var a; } } }",
			None,
		), /* { "ecmaVersion": 6 }, */
		(
		...
		(
			"function foo() { if (quux) { var a; } if (bar) { if (baz) { return true; } else { \
			 let a; } } }",
			None,
		), /* { "ecmaVersion": 6 }, */
		(
		...
		(
			"function foo() { if (bar) { if (baz) { return true; } else { let a; } } function \
			 a(){} }",
			None,
		), /* { "ecmaVersion": 6 }, */
		(
		...
		("if (foo) { return true; } else { let a; }", None), /* { "ecmaVersion": 6,
		                                                      * "sourceType": "commonjs" }, */
		("let a; if (foo) { return true; } else { let a; }", None), /* { "ecmaVersion": 6,
		                                                             * "sourceType": "commonjs"
		                                                             * } */
	];
	...
	let fix = vec![
		...
		(
			"function foo2() { if (true) { var x = bar; return x; } else { \
			 var y = baz; return y; } }",
			"function foo2() { if (true) { var x = bar; return x; }  var y = \
			 baz; return y;  }",
			None,
		),
		(
		...
		(
			"function foo4() { if (true) { if (false) return x; else return \
			 y; } else { return z; } }",
			"function foo4() { if (true) { if (false) return x; return y; }  \
			 return z;  }",
			None,
		),
		(
			"function foo5() { if (true) { if (false) { if (true) return x; \
			 else { w = y; } } else { w = x; } } else { return z; } }",
			"function foo5() { if (true) { if (false) { if (true) return x;  \
			 w = y;  } else { w = x; } } else { return z; } }",
			None,
		),
		(
			"function foo6() { if (true) { if (false) { if (true) return x; \
			 else return y; } } else { return z; } }",
			"function foo6() { if (true) { if (false) { if (true) return x; \
			 return y; } } else { return z; } }",
			None,
		),
		(
			"function foo7() { if (true) { if (false) { if (true) return x; \
			 else return y; } return w; } else { return z; } }",
			"function foo7() { if (true) { if (false) { if (true) return x; \
			 return y; } return w; }  return z;  }",
			None,
		),
		(
			"function foo8() { if (true) { if (false) { if (true) return x; \
			 else return y; } else { w = x; } } else { return z; } }",
			"function foo8() { if (true) { if (false) { if (true) return x; \
			 return y; }  w = x;  } else { return z; } }",
			None,
		),
		(
			"function foo9() {if (x) { return true; } else if (y) { return \
			 true; } else { notAReturn(); } }",
			"function foo9() {if (x) { return true; } else if (y) { return \
			 true; }  notAReturn();  }",
			None,
		),
		(
			"function foo9a() {if (x) { return true; } else if (y) { return \
			 true; } else { notAReturn(); } }",
			"function foo9a() {if (x) { return true; } if (y) { return true; \
			 } else { notAReturn(); } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
			"function foo9b() {if (x) { return true; } if (y) { return true; \
			 } else { notAReturn(); } }",
			"function foo9b() {if (x) { return true; } if (y) { return true; \
			 }  notAReturn();  }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		...
		(
			"function foo19() { if (true) { return x; } else if (false) { \
			 return y; } }",
			"function foo19() { if (true) { return x; } if (false) { return \
			 y; } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
			"function foo20() {if (x) { return true; } else if (y) { \
			 notAReturn() } else { notAReturn(); } }",
			"function foo20() {if (x) { return true; } if (y) { notAReturn() \
			 } else { notAReturn(); } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
			"function foo21() { var x = true; if (x) { return x; } else if (x \
			 === false) { return false; } }",
			"function foo21() { var x = true; if (x) { return x; } if (x === \
			 false) { return false; } }",
			Some(serde_json::json!([{ "allowElseIf": false }])),
		),
		(
		...
		(
			"function foo() { if (bar) { var a; if (baz) { return true; } \
			 else { var a; } } }",
			"function foo() { if (bar) { var a; if (baz) { return true; }  \
			 var a;  } }",
			None,
		...
		(
			"function foo() {let a; if (bar) { if (baz) { return true; } else \
			 { let a; } } }",
			"function foo() {let a; if (bar) { if (baz) { return true; }  let \
			 a;  } }",
			None,
		),
		(
			"function foo() { try {} catch (a) { if (bar) { if (baz) { return \
			 true; } else { let a; } } } }",
			"function foo() { try {} catch (a) { if (bar) { if (baz) { return \
			 true; }  let a;  } } }",
			None,
		...
		(
			"function foo() { if (bar) { if (baz) { return true; } else { let \
			 arguments; } } }",
			"function foo() { if (bar) { if (baz) { return true; }  let \
			 arguments;  } }",
			None,
		),
		(
			"function foo() { if (bar) { if (baz) { return true; } else { let \
			 a; } } a; }",
			"function foo() { if (bar) { if (baz) { return true; }  let a;  } \
			 a; }",
			None,
		),
		(
		...
		(
			"function foo() { if (quux) { var a; } if (bar) { if (baz) { \
			 return true; } else { let a; } } }",
			"function foo() { if (quux) { var a; } if (bar) { if (baz) { \
			 return true; }  let a;  } }",
			None,
		),
		...
		(
			"if (foo) { return true; } else { let a; }",
			"if (foo) { return true; }  let a; ",
			None,
		),
	];
