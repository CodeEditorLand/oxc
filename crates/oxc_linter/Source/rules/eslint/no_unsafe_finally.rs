...
impl Rule for NoUnsafeFinally {
	fn run<'a>(&self, node:&AstNode<'a>, ctx:&LintContext<'a>) {
		...
		for node_id in nodes.ancestor_ids(node.id()) {
			...
			let Some(parent_node_id) = nodes.parent_id(node_id) else {
				break;
			};
...
fn test() {
	...
	let pass = vec![
		...
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { \
			 console.log('hola!') } }",
			None,
		),
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { function \
			 a(x) { return x } } }",
			None,
		),
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { var a = \
			 function(x) { if(!x) { throw new Error() } } } }",
			None,
		),
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { var a = \
			 function(x) { while(true) { if(x) { break } else { continue } } } } }",
			None,
		),
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { var a = \
			 function(x) { label: while(true) { if(x) { break label; } else { continue } } } } }",
			None,
		),
		...
		(
			"var foo = function() { try { return 1; } catch(err) { return 2; } finally { var bar \
			 = () => { throw new Error(); }; } };",
			None,
		),
		(
		...
		(
			"var foo = function() { try { return 1; } finally { class bar { constructor() {} \
			 static ehm() { return 'Hola!'; } } } };",
			None,
		),
	];
	...
	let fail = vec![
		...
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { if(true) { \
		...
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { return \
			 function(x) { return y } } }",
			None,
		),
		(
		...
		(
			"var foo = function() { try { return 1 } catch(err) { return 2 } finally { throw new \
			 Error() } }",
			None,
		),
		(
		...
		(
			"var foo = function() { a: while (true) try {} finally { switch (true) { case true: \
			 break a; } } }",
			None,
		),
		(
		...
		(
			"var foo = function() { a: switch (true) { case true: try {} finally { switch (true) \
			 { case true: break a; } } } }",
			None,
		),
	];
