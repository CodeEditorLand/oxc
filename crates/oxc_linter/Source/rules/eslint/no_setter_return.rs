...
fn test() {
	...
	let pass = vec![
		...
		(
			"function foo(){} return 1; var bar = function*(){ return 1; }; return 1; var baz = \
			 () => {}; return 1;",
			None,
		),
		...
		(
			"function f() { Reflect.defineProperty(foo, 'bar', { set(val) { if (val) { return 1; \
			 } } }); var Reflect;}",
			None,
		),
		(
			"function f(Object) { Object.defineProperties(foo, { bar: { set(val) { try { return \
			 1; } catch(e){} } } }) }",
			None,
		),
		(
			"if (x) { const Object = getObject(); Object.create(foo, { bar: { set: function(val) \
			 { return 1; } } }) }",
			None,
		),
		(
	...
	let fail = vec![
		...
		(
			"class A { set a(val) { switch(val) { case 1: return x; case 2: return y; default: \
			 return z } } }",
			None,
		),
		(
			"(class { static set a(val) { if (val > 0) { this._val = val; return val; } return \
			 false; } })",
			None,
		),
		("({ set a(val) { if(val) { return 1; } else { return; }; } })", None),
		(
			"class A { set a(val) { switch(val) { case 1: return x; case 2: return; default: \
			 return z } } }",
			None,
		),
		(
		...
		// None), ("Reflect.defineProperty(foo, 'bar', { set(val) { return 1;
		// } })", None), ("Object.defineProperties(foo, { baz: { set(val) {
		// return 1; } } })", None), ("Object.create(null, { baz: { set(val)
		// { return 1; } } })", None), ("Object.defineProperty(foo, 'bar', {
		// set: val => val })", None), ("Reflect.defineProperty(foo, 'bar', {
		// set: val => f(val) })", None), ("Object.defineProperties(foo, {
		// baz: { set: val => a + b } })", None), ("Object.create({}, { baz:
		// { set: val => this._val } })", None), (
		// "Object.defineProperty(foo, 'bar', { set(val) { if (val) { return; }
		// return false; }, get(val) { return 1; } })", None,
		// ),
		// (
		// "Reflect.defineProperty(foo, 'bar', { set(val) { try { return f(val)
		// } catch (e) { return e }; } })", None,
		// ),
		// (
		// "Object.defineProperties(foo, { bar: { get(){ return null; },
		// set(val) { return null; } } })", None,
		// ),
		// (
		// "Object.create(null, { baz: { set(val) { return this._val; return;
		// return undefined; } } })", None,
		// ),
		// (
		// "Object.defineProperties(foo, { baz: { set(val) { return 1; } },
		// bar: { set(val) { return 1; } } })", None,
		// ),
		// ("Object.create({}, { baz: { set(val) { return 1; } }, bar: { set:
		// (val) => 1 } })", None), ("Object['defineProperty'](foo, 'bar', {
		// set: function bar(val) { return 1; } })", None),
		// ("Reflect.defineProperty(foo, 'bar', { 'set'(val) { return 1; } })",
		// None), ("Object[`defineProperties`](foo, { baz: { ['set'](val) {
		// return 1; } } })", None), ("Object.create({}, { baz: { [`set`]:
		// (val) => { return 1; } } })", None), ("Object.defineProperty(foo,
		// 'bar', { set: function Object(val) { return 1; } })", None),
		// ("Object.defineProperty(foo, 'bar', { set: function(Object) { return
		// 1; } })", None), ("Object?.defineProperty(foo, 'bar', { set(val) {
		// return 1; } })", None), ("(Object?.defineProperty)(foo, 'bar', {
		// set(val) { return 1; } })", None),
	];
