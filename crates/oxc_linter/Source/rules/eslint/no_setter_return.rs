...
fn test() {
	...
	let fail = vec![
		...
		// (
		// "Object.defineProperty(foo, 'bar', { set(val) { if (val) { return; } return false; },
		// get(val) { return 1; } })", None,
		// ),
		// (
		// "Reflect.defineProperty(foo, 'bar', { set(val) { try { return f(val) } catch (e) {
		// return e }; } })", None,
		// ),
		// (
		...
		// ),
		// (
		// "Object.defineProperties(foo, { baz: { set(val) { return 1; } }, bar: { set(val) {
		// return 1; } } })", None,
		// ),
		// ("Object.create({}, { baz: { set(val) { return 1; } }, bar: { set: (val) => 1 } })",
		// None), ("Object['defineProperty'](foo, 'bar', { set: function bar(val) { return 1; }
		// })", None), ("Reflect.defineProperty(foo, 'bar', { 'set'(val) { return 1; } })",
		// None), ("Object[`defineProperties`](foo, { baz: { ['set'](val) { return 1; } } })",
		// None), ("Object.create({}, { baz: { [`set`]: (val) => { return 1; } } })", None),
		// ("Object.defineProperty(foo, 'bar', { set: function Object(val) { return 1; } })",
		// None), ("Object.defineProperty(foo, 'bar', { set: function(Object) { return 1; } })",
		// None), ("Object?.defineProperty(foo, 'bar', { set(val) { return 1; } })", None),
		// ("(Object?.defineProperty)(foo, 'bar', { set(val) { return 1; } })", None),
	];
