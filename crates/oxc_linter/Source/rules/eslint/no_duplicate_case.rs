...
use oxc_span::{GetSpan, Span, cmp::ContentEq};
...
impl Rule for NoDuplicateCase {
	fn run<'a>(&self, node:&AstNode<'a>, ctx:&LintContext<'a>) {
		let Some(ss) = node.kind().as_switch_statement() else {
			return;
		};
...
fn test() {
	...
	let pass = vec![
		...
		"var a = 1, p = {p: {p1: 1, p2: 1}}; switch (a) {case p.p.p1: break; case p.p.p2: break; \
		 default: break;}",
		"var a = 1, f = function(b) { return b ? { p1: 1 } : { p1: 2 }; }; switch (a) {case \
		 f(true).p1: break; case f(true, false).p1: break; default: break;}",
		"var a = 1, f = function(s) { return { p1: s } }; switch (a) {case f(a + 1).p1: break; \
		 case f(a + 2).p1: break; default: break;}",
		"var a = 1, f = function(s) { return { p1: s } }; switch (a) {case f(a == 1 ? 2 : 3).p1: \
		 break; case f(a === 1 ? 2 : 3).p1: break; default: break;}",
		"var a = 1, f1 = function() { return { p1: 1 } }, f2 = function() { return { p1: 2 } }; \
		 switch (a) {case f1().p1: break; case f2().p1: break; default: break;}",
		"var a = [1,2]; switch(a.toString()){case ([1,2]).toString():break; case \
		 ([1]).toString():break; default:break;}",
	...
	let fail = vec![
		...
		"var a = '1'; switch (a) {case '1': break; case '1': break; case '2': break; default: \
		 break;}",
		"var a = 1, one = 1; switch (a) {case one: break; case one: break; case 2: break; \
		 default: break;}",
		"var a = 1, p = {p: {p1: 1, p2: 1}}; switch (a) {case p.p.p1: break; case p.p.p1: break; \
		 default: break;}",
		"var a = 1, f = function(b) { return b ? { p1: 1 } : { p1: 2 }; }; switch (a) {case \
		 f(true).p1: break; case f(true).p1: break; default: break;}",
		"var a = 1, f = function(s) { return { p1: s } }; switch (a) {case f(a + 1).p1: break; \
		 case f(a + 1).p1: break; default: break;}",
		"var a = 1, f = function(s) { return { p1: s } }; switch (a) {case f(a === 1 ? 2 : 3).p1: \
		 break; case f(a === 1 ? 2 : 3).p1: break; default: break;}",
		"var a = 1, f1 = function() { return { p1: 1 } }; switch (a) {case f1().p1: break; case \
		 f1().p1: break; default: break;}",
		"var a = [1, 2]; switch(a.toString()){case ([1, 2]).toString():break; case ([1, \
		 2]).toString():break; default:break;}",
		"switch (a) { case a: case a: }",
		"switch (a) { case a: break; case b: break; case a: break; case c: break; case a: break; }",
		"var a = 1, p = {p: {p1: 1, p2: 1}}; switch (a) {case p.p.p1: break; case p. p // \
		 comment\n .p1: break; default: break;}",
		"var a = 1, p = {p: {p1: 1, p2: 1}}; switch (a) {case p .p\n/* comment */\n.p1: break; \
		 case p.p.p1: break; default: break;}",
		"var a = 1, p = {p: {p1: 1, p2: 1}}; switch (a) {case p .p\n/* comment */\n.p1: break; \
		 case p. p // comment\n .p1: break; default: break;}",
		"var a = 1, p = {p: {p1: 1, p2: 1}}; switch (a) {case p.p.p1: break; case p. p // \
		 comment\n .p1: break; case p .p\n/* comment */\n.p1: break; default: break;}",
