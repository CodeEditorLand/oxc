...
fn test() {
	...
	let pass = vec![
		...
		// even though there is a typo match, this should not fail because a file is not inside
		// pages directory
		(
			r"
                export default function Page() {
		...
		// even though there is a typo match, this should not fail because a file is inside
		// pages/api directory
		(
			r"
                export default function Page() {
