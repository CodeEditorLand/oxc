...
impl Rule for CheckTagNames {
	...
	fn run_once(&self, ctx:&LintContext) {
		...
		// NOTE: The original rule seems to check `declare` context by visiting
		// AST nodes. https://github.com/gajus/eslint-plugin-jsdoc/blob/e343ab5b1efaa59b07c600138aee070b4083857e/src/rules/checkTagNames.js#L121
		// But...
...
fn test() {
	...
	Tester::new(CheckTagNames::NAME, dts_pass, dts_fail)
