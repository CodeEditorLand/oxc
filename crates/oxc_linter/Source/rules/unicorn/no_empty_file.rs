...
impl Rule for NoEmptyFile {
	fn run_once(&self, ctx:&LintContext) {
		...
		// only show diagnostic for the first 100 characters to avoid huge
		// diagnostic messages with empty programs containing a bunch of
		// comments. NOTE: if the enable/disable directives come after the
		// first 100 characters they won't be respected by this diagnostic.
