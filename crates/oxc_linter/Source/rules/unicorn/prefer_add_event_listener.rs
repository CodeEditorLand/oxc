...
const DOM_EVENT_TYPE_NAMES:phf::Set<&'static str> = phf::phf_set!(
	...
	"mouseenter",
	"mouseleave",
	// Non-existent event; will never fire. This exists as a mouse counterpart
	// to POINTERCANCEL.
	"mousecancel",
	// Selection events.
	...
	"dragend",
	// Touch events
	// Note that other touch events exist, but we should follow the W3C list
	// here. http://www.w3.org/TR/touch-events/#list-of-touchevent-types
	"touchstart",
	"touchmove",
	"touchend",
	"touchcancel",
	...
	"text",
	// The textInput event is supported in IE9+, but only in lower case. All
	// other browsers use the camel-case event name.
	"textinput",
	"textInput",
	"compositionstart",
	"compositionupdate",
