...
use crate::{
	...
	utils::{
		...
		get_return_identifier_name,
		is_empty_array_expression,
...
// - `[].concat.call([], maybeArray)` and `Array.prototype.concat.call([],
//   maybeArray)`
// - `[].concat.call([], ...array)` and `Array.prototype.concat.call([],
//   ...array)`
...
fn test() {
	...
	Tester::new(PreferArrayFlat::NAME, pass, fail)
		.expect_fix(fix)
		.test_and_snapshot();
}
