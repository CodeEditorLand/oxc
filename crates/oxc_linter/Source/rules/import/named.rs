...
fn test() {
	...
	let pass = vec![
		...
		// "import { ExtfieldModel, Extfield2Model } from './models';",       filename:
		// testFilePath('./export-star/downstream.js'), "const { something } =
		// require('./dynamic-import-in-commonjs')", "import { something } from
