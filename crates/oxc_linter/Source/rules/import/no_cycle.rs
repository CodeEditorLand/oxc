...
fn test() {
	...
	let pass = vec![
		...
		// (r#"import { foo } from "./external-depth-two""#,
	...
	let fail = vec![
		...
		// TODO: settings  'import/resolver': 'webpack', 'import/external-module-folders':
		// ['cycles/external'], (r#"import { foo } from "cycles/external/depth-one""#, None),
		// TODO: settings 'import/external-module-folders': ['cycles/external'],
