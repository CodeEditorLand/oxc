...
fn test() {
	...
	let pass = vec![
		...
		// r#"import foobar from
		// "./typescript-export-assign-default-reexport""#, r#"import React
		// from "./typescript-export-assign-default-namespace"#,
	...
	let fail = vec![
		...
		// TODO: `export =`
		// r#"import React from
		// "./typescript-export-assign-default-namespace""#,
