...
/// If the name is a namespace object in imported module, return the module
/// request name.
///
/// For example
/// ```ts
...
fn get_module_request_name(name:&str, module_record:&ModuleRecord) -> Option<String> {
	if let Some(entry) = module_record.indirect_export_entries.iter().find(|e| {
		match &e.import_name {
...
fn test() {
	...
	let pass = vec![
		...
		// r#"import * as Endpoints from "./issue-195/Endpoints";
		...
		// r#"import * as names from './default-export-string';
		// console.log(names.default)"#, r#"import * as names from
		// './default-export-namespace-string';"#, r#"import * as names from
		// './default-export-namespace-string'; console.log(names.default)"#,
	...
	let fail = vec![
		...
		(r#"import * as names from "./named-exports"; const { c: { d } } = names"#, None),
		// r#"import * as Endpoints from "./issue-195/Endpoints";
		// console.log(Endpoints.Foo)"#, r#"import * as namespace from
		// './malformed.js';"#, TODO: Hard to confirm if it's a namespace
		// object r"import b from './deep/default'; console.log(b.e)",
