...
impl Rule for NoLargeSnapshots {
	fn from_configuration(value:serde_json::Value) -> Self {
		...
		Self(Box::new(NoLargeSnapshotsConfig {
			max_size,
			inline_max_size,
			allowed_snapshots,
		}))
...
impl NoLargeSnapshots {
	...
	fn check_allowed_in_snapshots(&self, member_expr:&MemberExpression, ctx:&LintContext) -> bool {
...
fn test() {
	...
	// fn generate_exports_snapshot_string(lines: usize, title: Option<&str>) ->
	// String {     let title = title.unwrap_or("a big component 1");
	...
	// let fifty_eight_exports_snapshot = generate_exports_snapshot_string(58,
	// None);
	...
	let pass = vec![
		...
		// (twenty_exports_snapshot.as_str(), None, None,
		// Some(PathBuf::from(snap_path))), '/mock-component.jsx.snap'
		// (
	...
	// let fifty_two_exports_snapshot = generate_exports_snapshot_string(58,
	// None); let one_hundred_exports_snapshot =
	// generate_exports_snapshot_string(100, None); let one_exports_snapshot =
	// generate_exports_snapshot_string(1, None);
	// let fifty_eight_exports_snapshot = generate_exports_snapshot_string(58,
	// None); let vec_to_str = [
	//     generate_exports_snapshot_string(58, Some("a big component w/
	// text")),     generate_exports_snapshot_string(58, Some("a big component
	// 2")), ]
	// .join("\n\n");
	...
	let fail = vec![
		...
		// '/mock-component.jsx.snap'
		// (fifty_two_exports_snapshot.as_str(), None, None,
		// Some(PathBuf::from(snap_path))), '/mock-component.jsx.snap'
		// (
	...
	Tester::new(NoLargeSnapshots::NAME, pass, fail)
