...
fn test() {
	...
	let pass = vec![
		...
		(
			"
                ...
                describe('A', () => {
                    beforeEach(async () => { await new Promise(resolve => { setTimeout(resolve, \
			 10000).unref(); });});
                    it('A.1', async () => { await new Promise(resolve => { setTimeout(resolve, \
			 10000).unref(); });});
                    it('A.2', async () => { await new Promise(resolve => { setTimeout(resolve, \
			 10000).unref(); });});
                });
            ",
			None,
		...
		(
			"
                ...
                describe('A', () => {
                    beforeEach(async () => { await new Promise(resolve => { setTimeout(resolve, \
			 10000).unref(); });});
                    it('test foo', async () => { await new Promise(resolve => { \
	...
	Tester::new(NoConfusingSetTimeout::NAME, pass, fail)
