...
fn tests() {
	...
	let fail = vec![
		...
		(
			"obj.a.b = jest.fn(() => ({})).mockReturnValue('default').mockReturnValueOnce('first \
			 call'); test();",
			None,
		),
	...
	let fix = vec![
		...
		(
			"obj.a = jest.fn(() => 10,)",
			"jest.spyOn(obj, 'a').mockImplementation(() => 10)",
			None,
		),
		(
			"obj.a.b = jest.fn(() => ({})).mockReturnValue('default').mockReturnValueOnce('first \
			 call'); test();",
			"jest.spyOn(obj.a, 'b').mockImplementation(() => \
			 ({})).mockReturnValue('default').mockReturnValueOnce('first call'); test();",
			None,
		),
		(
