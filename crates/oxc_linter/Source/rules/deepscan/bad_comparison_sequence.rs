...
#[diagnostic(
	severity(warning),
	help(
		"Comparison result should not be used directly as an operand of another comparison. If \
		 you need to compare three or more operands, you should connect each comparison operation \
