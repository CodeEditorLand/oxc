...
fn test() {
	...
	let pass = vec![
		...
		// Some(serde_json::json!(components))), (r#"<Anchor href='foo' onClick={() => void 0}
		// />"#, Some(serde_json::json!(components))), (r#"<Anchor href={foo} onClick={() => void
		// 0} />"#, Some(serde_json::json!(components))), (r#"<Anchor href='/foo' onClick={() =>
		...
		// ),
		// (r#"<Anchor href='#foo' onClick={() => void 0} />"#,
		// Some(serde_json::json!(components))), (r#"<Link {...props} onClick={() => void 0}
		// />"#, Some(serde_json::json!(components))), (r#"<Link href='foo' onClick={() => void
		// 0} />"#, Some(serde_json::json!(components))), (r#"<Link href={foo} onClick={() =>
		// void 0} />"#, Some(serde_json::json!(components))), (r#"<Link href='/foo' onClick={()
		// => void 0} />"#, Some(serde_json::json!(components))), (
		...
		// Some(serde_json::json!(components))), (r#"<Link href={'foo'} onClick={() => void 0}
		// />"#, Some(serde_json::json!(components))), (r#"<Link href='#foo' onClick={() => void
		// 0} />"#, Some(serde_json::json!(components))), (r#"<a {...props} onClick={() => void
		// 0} />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefLeft='foo' onClick={() =>
		// void 0} />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefLeft={foo} onClick={()
		// => void 0} />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefLeft='/foo'
		...
		// ),
		// (r#"<a hrefLeft='#foo' onClick={() => void 0} />"#,
		// Some(serde_json::json!(specialLink))), (r#"<a hrefRight={this} onClick={() => void 0}
		// />"#, Some(serde_json::json!(specialLink))), (r#"<a {...props} onClick={() => void 0}
		// />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefRight='foo' onClick={() =>
		// void 0} />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefRight={foo}
		// onClick={() => void 0} />"#, Some(serde_json::json!(specialLink))), (
	...
	let fail = vec![
		...
		// (r#"<a onClick={() => void 0} />"#,
		// Some(serde_json::json!(preferButtonInvalidHrefAspect))), (r#"<a onClick={() => void 0}
		// />"#, Some(serde_json::json!(noHrefPreferButtonAspect))), (r#"<a onClick={() => void
		// 0} />"#, Some(serde_json::json!(noHrefAspect))), (r#"<a onClick={() => void 0} />"#,
		// Some(serde_json::json!(noHrefInvalidHrefAspect))), (r#"<a href='#' onClick={() => void
		// 0} />"#, Some(serde_json::json!(preferButtonAspect))), (
