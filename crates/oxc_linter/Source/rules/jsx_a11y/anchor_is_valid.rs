...
impl Rule for AnchorIsValid {
	...
	fn run<'a>(&self, node:&AstNode<'a>, ctx:&LintContext<'a>) {
		if let AstKind::JSXElement(jsx_el) = node.kind() {
			...
			// Don't eagerly get `span` here, to avoid that work unless rule
			// fails
			...
			let has_spread_attr = jsx_el.opening_element.attributes.iter().any(|attr| {
				match attr {
...
impl AnchorIsValidConfig {
	...
	fn contains(&self, href:&str) -> bool {
		self.valid_hrefs
			.binary_search_by(|valid_href| valid_href.as_str().cmp(href))
			.is_ok()
	}
}
...
fn test() {
	...
	let pass = vec![
		...
		// (r#"<a hrefLeft={'foo'}/>"#, Some(serde_json::json!(specialLink))),
		// (r#"<a hrefLeft='#foo' />"#, Some(serde_json::json!(specialLink))),
		// (r#"<UX.Layout>test</UX.Layout>"#,
		// Some(serde_json::json!(specialLink))), (r#"<a hrefRight={this}
		// />"#, Some(serde_json::json!(specialLink))), (r#"<a {...props}
		// />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefRight='
		// foo' />"#, Some(serde_json::json!(specialLink))),
		// (r#"<a hrefRight={foo} />"#, Some(serde_json::json!(specialLink))),
		// (r#"<a hrefRight='/foo' />"#, Some(serde_json::json!(specialLink))),
		// (r#"<a hrefRight='https://foo.bar.com' />"#, Some(serde_json::json!(specialLink))),
		// (r#"<div hrefRight='foo' />"#,
		// Some(serde_json::json!(specialLink))), (r#"<a hrefRight={`#foo`}/
		// >"#, Some(serde_json::json!(specialLink))), (r#"<a hrefRight={'
		// foo'}/>"#, Some(serde_json::json!(specialLink))),
		// (r#"<a hrefRight='#foo' />"#, Some(serde_json::json!(specialLink))),
		// (r#"<UX.Layout>test</UX.Layout>"#,
		// Some(serde_json::json!(specialLink))), (r#"<a hrefRight={this}
		// />"#, Some(serde_json::json!(specialLink))), (r#"<Anchor
		// {...props} />"#, Some(serde_json::json!(componentsAndSpecialLink))),
		// (r#"<Anchor hrefLeft='foo' />"#,
		// Some(serde_json::json!(componentsAndSpecialLink))), (r#"<Anchor
		// hrefLeft={foo} />"#,
		// Some(serde_json::json!(componentsAndSpecialLink))), (r#"<Anchor
		// hrefLeft='/foo' />"#,
		...
		// Some(serde_json::json!(components))), (r#"<Anchor href='foo'
		// onClick={() => void 0} />"#, Some(serde_json::json!(components))),
		...
		// ),
		// (r#"<Anchor href='#foo' onClick={() => void 0} />"#,
		// Some(serde_json::json!(components))), (r#"<Link {...props}
		// onClick={() => void 0} />"#, Some(serde_json::json!(components))),
		// (r#"<Link href='foo' onClick={() => void 0} />"#,
		// Some(serde_json::json!(components))), (r#"<Link href={foo}
		// onClick={() => void 0} />"#, Some(serde_json::json!(components))),
		// (r#"<Link href='/foo' onClick={() => void 0} />"#,
		// Some(serde_json::json!(components))), (
		...
		// Some(serde_json::json!(components)),
		// ),
		// (r#"<div href='foo' onClick={() => void 0} />"#,
		// Some(serde_json::json!(components))), (r#"<Link href={`#foo`}
		// onClick={() => void 0} />"#, Some(serde_json::json!(components))),
		// (r#"<Link href={'foo'} onClick={() => void 0} />"#,
		// Some(serde_json::json!(components))), (r#"<Link href='#foo'
		// onClick={() => void 0} />"#, Some(serde_json::json!(components))),
		// (r#"<a {...props} onClick={() => void 0} />"#,
		// Some(serde_json::json!(specialLink))), (r#"<a hrefLeft='foo'
		// onClick={() => void 0} />"#, Some(serde_json::json!(specialLink))),
		...
		// (r#"<a href={undefined} />"#,
		// Some(serde_json::json!(invalidHrefAspect))), (r#"<a href={null}
		// />"#, Some(serde_json::json!(invalidHrefAspect))), (r#"<a />"#,
		// Some(serde_json::json!(preferButtonAspect))),
		// (r#"<a href={undefined} />"#,
		// Some(serde_json::json!(preferButtonAspect))), (r#"<a href={null}
		// />"#, Some(serde_json::json!(preferButtonAspect))), (r#"<a />"#,
		...
		// (r#"<a href='#' />"#, Some(serde_json::json!(preferButtonAspect))),
		// (r#"<a href={'#'} />"#,
		// Some(serde_json::json!(preferButtonAspect))), (r#"<a href='
		// javascript:void(0)' />"#,
		// Some(serde_json::json!(preferButtonAspect))), (r#"<a href={'
		// javascript:void(0)'} />"#,
		// Some(serde_json::json!(preferButtonAspect))), (r#"<a href=' />;"#,
		// Some(serde_json::json!(noHrefAspect))), (r#"<a href='#' />"#,
		// Some(serde_json::json!(noHrefAspect))), (r#"<a href={'#'} />"#,
		// Some(serde_json::json!(noHrefAspect))), (r#"<a href='javascript:
		// void(0)' />"#, Some(serde_json::json!(noHrefAspect))),
		// (r#"<a href={'javascript:void(0)'} />"#,
		// Some(serde_json::json!(noHrefAspect))), (r#"<a href=' />;"#,
		// Some(serde_json::json!(noHrefPreferButtonAspect))), (r#"<a href='#
		// ' />"#, Some(serde_json::json!(noHrefPreferButtonAspect))), (r#"<a
		// href={'#'} />"#, Some(serde_json::json!(noHrefPreferButtonAspect))),
		// (r#"<a href='javascript:void(0)' />"#,
		...
		// ),
		// (r#"<a onClick={() => void 0} />"#,
		// Some(serde_json::json!(invalidHrefAspect))), (r#"<a href='#'
		// onClick={() => void 0} />"#, Some(serde_json::json!(noHrefAspect))),
		// (
	...
	let fail = vec![
		...
		// (r#"<Link href={undefined} />"#,
		// Some(serde_json::json!(components))), (r#"<Link href={null} />"#,
		// Some(serde_json::json!(components))), (r#"<Link href=' />"#,
		// Some(serde_json::json!(components))), (r#"<Link href='#' />"#,
		// Some(serde_json::json!(components))), (r#"<Link href={'#'} />"#,
		// Some(serde_json::json!(components))), (r#"<Link href='javascript:
		// void(0)' />"#, Some(serde_json::json!(components))),
		// (r#"<Link href={'javascript:void(0)'} />"#,
		// Some(serde_json::json!(components))), (r#"<Anchor href=' />"#,
		// Some(serde_json::json!(components))), (r#"<Anchor href='#' />"#,
		// Some(serde_json::json!(components))), (r#"<Anchor href={'#'} />"#,
		// Some(serde_json::json!(components))), (r#"<Anchor
		// href='javascript:void(0)' />"#,
		// Some(serde_json::json!(components))), (r#"<Anchor
		// href={'javascript:void(0)'} />"#,
		// Some(serde_json::json!(components))), (r#"<Link onClick={() =>
		// void 0} />"#, Some(serde_json::json!(components))),
		...
		// (r#"<a hrefLeft={undefined} />"#,
		// Some(serde_json::json!(specialLink))), (r#"<a hrefLeft={null}
		// />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefLeft='
		// />;"#, Some(serde_json::json!(specialLink))), (r#"<a hrefLeft='#'
		// />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefLeft={'#'}
		// />"#, Some(serde_json::json!(specialLink))), (r#"<a hrefLeft='
		// javascript:void(0)' />"#, Some(serde_json::json!(specialLink))),
		// (r#"<a hrefLeft={'javascript:void(0)'} />"#,
		// Some(serde_json::json!(specialLink))), (r#"<a hrefLeft='#'
		// onClick={() => void 0} />"#, Some(serde_json::json!(specialLink))),
		// (
		...
		// (r#"<a href={undefined} />"#,
		// Some(serde_json::json!(noHrefAspect))), (r#"<a href={undefined}
		// />"#, Some(serde_json::json!(noHrefPreferButtonAspect))),
		// (r#"<a href={undefined} />"#,
		...
		// Some(serde_json::json!(noHrefPreferButtonAspect))),
		// (r#"<a href={null} />"#,
		// Some(serde_json::json!(noHrefInvalidHrefAspect))), (r#"<a href='
		// />;"#, Some(serde_json::json!(invalidHrefAspect))), (r#"<a href='
		// />;"#, Some(serde_json::json!(noHrefInvalidHrefAspect))),
		// (r#"<a href=' />;"#,
		// Some(serde_json::json!(preferButtonInvalidHrefAspect))),
		...
		// ),
		// (r#"<a onClick={() => void 0} />"#,
		// Some(serde_json::json!(preferButtonAspect))), (r#"<a onClick={()
		// => void 0} />"#,
		// Some(serde_json::json!(preferButtonInvalidHrefAspect))),
		// (r#"<a onClick={() => void 0} />"#,
		// Some(serde_json::json!(noHrefPreferButtonAspect))),
		// (r#"<a onClick={() => void 0} />"#,
		// Some(serde_json::json!(noHrefAspect))), (r#"<a onClick={() => void
		// 0} />"#, Some(serde_json::json!(noHrefInvalidHrefAspect))), (r#"<a
		// href='#' onClick={() => void 0} />"#,
		// Some(serde_json::json!(preferButtonAspect))), (
