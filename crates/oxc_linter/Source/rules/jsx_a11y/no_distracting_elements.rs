...
fn no_distracting_elements_diagnostic(span:Span) -> OxcDiagnostic {
	OxcDiagnostic::warn(
		"Do not use <marquee> or <blink> elements as they can create visual accessibility issues \
		 and are deprecated.",
	)
	.with_help(
		"Replace the <marquee> or <blink> element with alternative, more accessible ways to \
