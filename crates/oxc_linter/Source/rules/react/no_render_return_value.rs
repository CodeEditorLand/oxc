...
fn test() {
	...
	let fail = vec![
		...
		// This rule is only supported for react versions >= 15.0.0, so the following are not
		// supported. See https://github.com/oxc-project/oxc/pull/1042#discussion_r1369762147
