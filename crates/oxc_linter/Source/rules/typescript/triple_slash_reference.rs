...
impl Rule for TripleSlashReference {
	...
	fn run_once(&self, ctx:&LintContext) {
		...
		// We don't need to iterate over all comments since Triple-slash directives are
		// only valid at the top of their containing file. We are trying to get the
		// first statement start potioin, falling back to the program end if statement
		// does not exist
