...
pub enum LegalComment {
	...
	Eof,
	/// Return all legal comments and link then to them with a comment to the
	/// provided string.
	Linked(String),
...
impl LegalComment {
	...
	/// Is inline mode.
	pub fn is_inline(&self) -> bool { *self == Self::Inline }

	/// Is EOF mode.
	pub fn is_eof(&self) -> bool { *self == Self::Eof }
}
...
pub struct CodegenOptions {
	...
	/// Print annotation comments, e.g. `/* #__PURE__ */` and `/*
	/// #__NO_SIDE_EFFECTS__ */`.
	///
