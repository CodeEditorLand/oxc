...
impl CoolIndex {
	...
	#[inline(always)]
	pub fn from_foreign<F:crate::Idx>(value:F) -> Self { Self::from_usize(value.index()) }

	/// Construct from a usize without any checks.
	#[inline(always)]
	pub const fn from_usize_unchecked(value:usize) -> Self { Self { _raw:value as u32 } }
	...
	#[inline(always)]
	pub const fn index(self) -> usize { self._raw as usize }

	/// Get the wrapped index.
	#[inline(always)]
	pub const fn raw(self) -> u32 { self._raw }
...
impl PartialEq<CoolIndex> for usize {
	#[inline]
	fn eq(&self, other:&CoolIndex) -> bool { *self == other.index() }
}
impl core::ops::Add<usize> for CoolIndex {
	type Output = Self;

	#[inline]
	fn add(self, other:usize) -> Self { Self::new(self.index().wrapping_add(other)) }
}
impl core::ops::Sub<usize> for CoolIndex {
	type Output = Self;

	#[inline]
	fn sub(self, other:usize) -> Self { Self::new(self.index().wrapping_sub(other)) }
}
...
impl core::ops::Add<CoolIndex> for usize {
	...
	#[inline]
	fn add(self, other:CoolIndex) -> CoolIndex { other + self }
}
impl core::ops::Sub<CoolIndex> for usize {
	type Output = CoolIndex;

	#[inline]
	fn sub(self, other:CoolIndex) -> CoolIndex { CoolIndex::new(self.wrapping_sub(other.index())) }
}
impl core::ops::Add for CoolIndex {
	type Output = CoolIndex;

	#[inline]
	fn add(self, other:CoolIndex) -> CoolIndex { CoolIndex::new(other.index() + self.index()) }
}
...
impl core::ops::AddAssign for CoolIndex {
	#[inline]
	fn add_assign(&mut self, other:CoolIndex) { *self = *self + other }
}
impl core::ops::SubAssign for CoolIndex {
	#[inline]
	fn sub_assign(&mut self, other:CoolIndex) { *self = *self - other; }
}
...
impl From<CoolIndex> for usize {
	#[inline]
	fn from(v:CoolIndex) -> usize { v.index() }
}
impl From<usize> for CoolIndex {
	#[inline]
	fn from(value:usize) -> Self { CoolIndex::from_usize(value) }
}
const _:[(); 1] = [(); true as usize];
impl From<CoolIndex> for u32 {
	#[inline]
	fn from(v:CoolIndex) -> u32 { v.raw() }
}
...
impl Default for CoolIndex {
	#[inline]
	fn default() -> Self { CoolIndex::new(0) }
}
