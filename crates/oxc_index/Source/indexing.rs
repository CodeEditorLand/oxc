...
impl<I:Idx, T> IdxSliceIndex<I, T> for I {
	...
	#[inline]
	fn get(self, slice:&IndexSlice<I, [T]>) -> Option<&Self::Output> { slice.raw.get(self.index()) }
	...
	#[inline]
	fn index(self, slice:&IndexSlice<I, [T]>) -> &Self::Output { &slice.raw[self.index()] }
...
impl<I:Idx, T> IdxSliceIndex<I, T> for core::ops::RangeFull {
	...
	#[inline]
	fn get(self, slice:&IndexSlice<I, [T]>) -> Option<&Self::Output> { Some(slice) }

	#[inline]
	fn get_mut(self, slice:&mut IndexSlice<I, [T]>) -> Option<&mut Self::Output> { Some(slice) }

	#[inline]
	fn index(self, slice:&IndexSlice<I, [T]>) -> &Self::Output { slice }

	#[inline]
	fn index_mut(self, slice:&mut IndexSlice<I, [T]>) -> &mut Self::Output { slice }
}
...
impl<I:Idx> IdxRangeBounds<I> for core::ops::Range<I> {
	...
	#[inline]
	fn into_range(self) -> Self::Range { self.start.index()..self.end.index() }
}
...
impl<I:Idx> IdxRangeBounds<I> for core::ops::RangeFrom<I> {
	...
	#[inline]
	fn into_range(self) -> Self::Range { self.start.index().. }
}
...
impl<I:Idx> IdxRangeBounds<I> for core::ops::RangeFull {
	...
	#[inline]
	fn into_range(self) -> Self::Range { self }
}
...
impl<I:Idx> IdxRangeBounds<I> for core::ops::RangeTo<I> {
	...
	#[inline]
	fn into_range(self) -> Self::Range { ..self.end.index() }
}
	...
	R: IdxSliceIndex<I, T>,
{
	...
	#[inline]
	fn index(&self, index:R) -> &R::Output { index.index(self) }
}
...
{
	#[inline]
	fn index_mut(&mut self, index:R) -> &mut R::Output { index.index_mut(self) }
}
