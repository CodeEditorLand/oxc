...
impl<I: Idx, T> IndexVec<I, T> {
	...
	#[inline]
	pub fn drain<R: IdxRangeBounds<I>>(
		&mut self,
		range: R,
	) -> vec::Drain<'_, T> {
	...
	#[inline]
	pub fn dedup_by_key<F: FnMut(&mut T) -> K, K: PartialEq>(
		&mut self,
		key: F,
	) {
...
impl<I: Idx, T: serde::ser::Serialize> serde::ser::Serialize
	for IndexVec<I, T>
{
