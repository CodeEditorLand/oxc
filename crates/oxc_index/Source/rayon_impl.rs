...
use rayon::{
	iter::{
		...
		IndexedParallelIterator, IntoParallelIterator, ParallelDrainRange,
		ParallelIterator,
	},
	slice::{Iter, IterMut},
};
...
impl<'data, I: Idx, T: Sync + 'data> IntoParallelIterator
	for &'data IndexVec<I, T>
{
	type Item = &'data T;
...
impl<'data, I: Idx, T: Send + 'data> IntoParallelIterator
	for &'data mut IndexVec<I, T>
{
...
impl<'data, I: Idx, T: Send> ParallelDrainRange<usize>
	for &'data mut IndexVec<I, T>
{
	type Item = T;
