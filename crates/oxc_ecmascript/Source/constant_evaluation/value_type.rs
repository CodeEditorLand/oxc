...
impl ValueType {
	...
	pub fn is_bigint(self) -> bool { matches!(self, Self::BigInt) }
...
/// resolve to. Without proper type information some assumptions had to be made
/// for operations that could result in a BigInt or a Number. If there is not
/// enough information available to determine one or the other then we assume
/// Number in order to maintain historical behavior of the compiler and
