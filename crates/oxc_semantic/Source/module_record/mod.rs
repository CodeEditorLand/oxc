...
mod module_record_tests {
	...
	// Table 55 gives examples of ImportEntry records fields used to represent
	// the syntactic import forms: `https://tc39.es/ecma262/#table-import-forms-mapping-to-importentry-records`
	...
	// Table 57 gives examples of the ExportEntry record fields used to
	// represent the syntactic export forms `https://tc39.es/ecma262/#table-export-forms-mapping-to-exportentry-records`
