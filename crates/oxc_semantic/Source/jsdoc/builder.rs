...
impl<'a> JSDocBuilder<'a> {
	...
	//  although some may already be inconsistent when converted from Token to AST
	// nodes).
	//
	...
	//  visit `FunctionDeclaration`, find `params.items`, get attached JSDoc, and
	// ... OK.
	//
	// Then how about this?
	//
	...
	//
	// Therefore, the `should_attach_jsdoc()` function and its candidates should be
	// carefully listed.
	//
	// As many reasonable types as possible should be listed, as long as it does not
	// affect performance...!
	//
