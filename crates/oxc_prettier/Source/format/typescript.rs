...
impl<'a> Format<'a> for TSAnyKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("any") }
}

impl<'a> Format<'a> for TSBigIntKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("bigint") }
}

impl<'a> Format<'a> for TSBooleanKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("boolean") }
}

impl<'a> Format<'a> for TSIntrinsicKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("intrinsic") }
}

impl<'a> Format<'a> for TSNeverKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("never") }
}
...
impl<'a> Format<'a> for TSNumberKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("number") }
}

impl<'a> Format<'a> for TSObjectKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("object") }
}

impl<'a> Format<'a> for TSStringKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("string") }
}

impl<'a> Format<'a> for TSSymbolKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("symbol") }
}
...
impl<'a> Format<'a> for TSUndefinedKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("undefined") }
}

impl<'a> Format<'a> for TSUnknownKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("unknown") }
}

impl<'a> Format<'a> for TSVoidKeyword {
	fn format(&self, p:&mut Prettier<'a>) -> Doc<'a> { text!("void") }
}
