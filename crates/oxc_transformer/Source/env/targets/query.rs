...
use super::{Versions, version::Version};
...
impl Default for Targets {
	fn default() -> Self { Targets::Query(Query::Single("defaults".into())) }
}
...
impl Targets {
	...
	pub fn from_query(query:&str) -> Self { Targets::Query(Query::Single(query.into())) }
