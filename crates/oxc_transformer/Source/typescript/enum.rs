	...
	fn evaluate_ref(
		...
		match expr {
			...
			Expression::Identifier(ident) => {
				...
				// corresponds to the identifier reference. and then we may to evaluate the
				// initializer of the BindingIdentifier. finally, we can get the value of
				// the identifier and call the `computed_constant_value` function. See https://github.com/babel/babel/blob/610897a9a96c5e344e77ca9665df7613d2f88358/packages/babel-plugin-transform-typescript/src/enum.ts#L327-L329
				None
			},
