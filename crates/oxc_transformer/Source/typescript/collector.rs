...
/// Indicates whether the BindingIdentifier is referenced or used in the
...
impl<'a> TypeScriptReferenceCollector<'a> {
	pub fn new() -> Self { Self { names:FxHashSet::default() } }

	pub fn has_reference(&self, name:&Atom) -> bool { self.names.contains(name) }
