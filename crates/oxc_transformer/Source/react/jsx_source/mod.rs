...
///
/// This plugin is included in `preset-react` and only enabled in development
/// mode.
///
/// ## Example
///
/// In: `<sometag />`
/// Out: `<sometag __source={ { fileName: 'this/file.js', lineNumber: 10,
/// columnNumber: 1 } } />`
...
impl<'a> ReactJsxSource<'a> {
	pub fn new(ctx:Ctx<'a>) -> Self { Self { ctx } }
