...
impl JsxRuntime {
	pub fn is_classic(self) -> bool { self == Self::Classic }

	pub fn is_automatic(self) -> bool { self == Self::Automatic }
}
...
pub struct JsxOptions {
	...
	/// Toggles whether or not to throw an error if a XML namespaced tag name
	/// is used.
	///
...
pub struct ReactRefreshOptions {
	...
	/// readable signatures for React components and hooks. This can be useful
...
fn default_refresh_reg() -> String { String::from("$RefreshReg$") }

fn default_refresh_sig() -> String { String::from("$RefreshSig$") }
