...
impl ES2018Options {
	pub fn with_object_rest_spread(&mut self, option:Option<ObjectRestSpreadOptions>) -> &mut Self {
	...
	pub fn from_targets_and_bugfixes(targets:Option<&Versions>, bugfixes:bool) -> Self {
		Self {
			object_rest_spread:can_enable_plugin("transform-object-rest-spread", targets, bugfixes)
