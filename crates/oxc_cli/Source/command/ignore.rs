...
pub struct IgnoreOptions {
	...
	/// Specify patterns of files to ignore (in addition to those in
	/// .eslintignore)
	///
	/// The supported syntax is the same as for .eslintignore and .gitignore
	/// files You should quote your patterns in order to avoid shell
	/// interpretation of glob patterns
