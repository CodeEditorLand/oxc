...
impl MagicString {
	...
	#[napi]
	pub fn length(&self) -> u32 { self.cell.borrow_dependent().len() as u32 }

	#[napi]
	#[allow(clippy::inherent_to_string)]
	pub fn to_string(&self) -> String { self.cell.borrow_dependent().to_string() }
	...
	// });
	// let map = self.cell.borrow_dependent().source_map(options.
	// unwrap_or_default()); oxc_sourcemap::napi::SourceMap::from(map)
	// }
