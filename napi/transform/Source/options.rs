...
pub struct JsxOptions {
	...
	/// is used.
	///
	/// Though the JSX spec allows this, it is disabled by default since
	/// React's JSX does not currently have support for it.
	///
	/// @default true
	...
	/// Replace the function used when compiling JSX expressions. It should be
	/// a qualified name (e.g. `React.createElement`) or an identifier (e.g.
	/// `createElement`).
	///
