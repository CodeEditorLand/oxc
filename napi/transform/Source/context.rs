...
impl<'a> TransformContext<'a> {
	...
	#[inline]
	pub fn file_name(&self) -> &'a str { self.filename }

	#[inline]
	pub fn file_path(&self) -> &'a Path { Path::new(self.filename) }
	...
	#[inline]
	pub fn program(&self) -> Ref<'_, Program<'a>> { self.program.borrow() }

	#[inline]
	pub fn program_mut(&self) -> RefMut<'_, Program<'a>> { self.program.borrow_mut() }
