...
pub fn check_semantic_after_transform(
	...
	// NB: `CloneIn` sets all `scope_id`, `symbol_id` and `reference_id` fields in
	// AST to `None`, so the cloned AST will be "clean" of all semantic data, as if
	// it had come fresh from the parser.
