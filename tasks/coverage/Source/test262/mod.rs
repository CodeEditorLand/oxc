...
impl Case for Test262Case {
	...
	fn always_strict(&self) -> bool { self.always_strict }
	...
	// contents must be modified prior to execution-- a "use strict" directive must
	// be inserted as the initial character sequence of the file https://github.com/tc39/test262/blob/05c45a4c430ab6fee3e0c7f0d47d8a30d8876a6d/INTERPRETING.md#strict-mode
	fn run(&mut self) {
